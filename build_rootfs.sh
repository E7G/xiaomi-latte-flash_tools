...
EOF
	...
	install -Dm0644 "$device_file/mipad2-camera-calibration.service" \
		"$mount_dir/etc/systemd/system/mipad2-camera-calibration.service"
	run $enable mipad2-camera-calibration.service
