 ...
 */
DefinitionBlock ("", "DSDT", 2, "INTEL ", "EDK2    ", 0x00000004)
{
    /*
    ...
    OperationRegion (GNVS, SystemMemory, 0x7B326000, 0x0364)
    ...
    Scope (_SB.PCI0)
    {
        ...
        Device (KP00)
        {
            Name (_HID, "TPS61158")  // _HID: Hardware ID
            Name (_CID, "TPS61158")  // _CID: Compatible ID
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                If ((OSID == 0x04))
                {
        ...
        Device (GDM2)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (RBUF, \_SB.PCI0.GDM2._Y06._BAS, B0BA)  // _BAS: Base Address
                CreateDWordField (RBUF, \_SB.PCI0.GDM2._Y06._LEN, B0LN)  // _LEN: Length
                B0BA = D10A /* \D10A */
                B0LN = D10L /* \D10L */
        ...
        Device (GDM4)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (RBUF, \_SB.PCI0.GDM4._Y08._BAS, B0BA)  // _BAS: Base Address
                CreateDWordField (RBUF, \_SB.PCI0.GDM4._Y08._LEN, B0LN)  // _LEN: Length
                B0BA = D20A /* \D20A */
                B0LN = D20L /* \D20L */
        ...
        Device (URT1)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Else
                {
                    CreateDWordField (ABUF, \_SB.PCI0.URT1._Y0C._BAS, ABBA)  // _BAS: Base Address
                    CreateDWordField (ABUF, \_SB.PCI0.URT1._Y0C._LEN, ABLN)  // _LEN: Length
                    ABBA = U10A /* \U10A */
                    ABLN = U10L /* \U10L */
            ...
            Device (BTH1)
            {
                Name (_HID, "BCM2E9C")  // _HID: Hardware ID
                Method (_STA, 0, NotSerialized)  // _STA: Status
                {
                    If ((WITT == One))
                    {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (UBUF) /* \_SB_.PCI0.URT1.BTH1._CRS.UBUF */
                }
            }
        ...
        Device (URT2)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Else
                {
                    CreateDWordField (ABUF, \_SB.PCI0.URT2._Y0E._BAS, ABBA)  // _BAS: Base Address
                    CreateDWordField (ABUF, \_SB.PCI0.URT2._Y0E._LEN, ABLN)  // _LEN: Length
                    ABBA = U20A /* \U20A */
                    ABLN = U20L /* \U20L */
        ...
        Device (SPI1)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (RBUF, \_SB.PCI0.SPI1._Y0F._BAS, B0BA)  // _BAS: Base Address
            ...
            {
                Name (_ADR, Zero)  // _ADR: Address
                Name (_HID, "WM828001")  // _HID: Hardware ID
                Name (_CID, "WM828001")  // _CID: Compatible ID
                Name (_DDN, "Wolfson Microelectronics Audio WM8280")  // _DDN: DOS Device Name
                Name (_UID, One)  // _UID: Unique ID
                Name (_DEP, Package (0x01)  // _DEP: Dependencies
                {
                    ^^I2C7.PMIC
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.PCI0.SPI1.WOLF._CRS.SBUF */
                }

                Method (_STA, 0, NotSerialized)  // _STA: Status
                {
                    If (((SKRS == One) && (WLFN == Zero)))
                    {
                        Return (0x0F)
                    }
        ...
        Device (SPI2)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (RBUF, \_SB.PCI0.SPI2._Y10._BAS, B0BA)  // _BAS: Base Address
                CreateDWordField (RBUF, \_SB.PCI0.SPI2._Y10._LEN, B0LN)  // _LEN: Length
                B0BA = S20A /* \S20A */
                B0LN = S20L /* \S20L */
        ...
        Device (SPI3)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (RBUF, \_SB.PCI0.SPI3._Y11._BAS, B0BA)  // _BAS: Base Address
                CreateDWordField (RBUF, \_SB.PCI0.SPI3._Y11._LEN, B0LN)  // _LEN: Length
                B0BA = S30A /* \S30A */
                B0LN = S30L /* \S30L */
        ...
        Device (I2C1)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (RBUF, \_SB.PCI0.I2C1._Y12._BAS, B0BA)  // _BAS: Base Address
                CreateDWordField (RBUF, \_SB.PCI0.I2C1._Y12._LEN, B0LN)  // _LEN: Length
                B0BA = I10A /* \I10A */
                B0LN = I10L /* \I10L */
        ...
        Device (I2C2)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (RBUF, \_SB.PCI0.I2C2._Y13._BAS, B0BA)  // _BAS: Base Address
                CreateDWordField (RBUF, \_SB.PCI0.I2C2._Y13._LEN, B0LN)  // _LEN: Length
                B0BA = I20A /* \I20A */
                B0LN = I20L /* \I20L */
            ...
            {
                Name (_ADR, Zero)  // _ADR: Address
                Name (_HID, "10EC5659")  // _HID: Hardware ID
                Name (_CID, "10EC5659")  // _CID: Compatible ID
                Name (_UID, One)  // _UID: Unique ID
                Name (_PR0, Package (0x01)  // _PR0: Power Resources for D0
                {
                    CLK3
            ...
            Device (RTK3)
            {
                ...
                Name (_HID, "10EC5659")  // _HID: Hardware ID
                Name (_CID, "10EC5659")  // _CID: Compatible ID
                Name (_SUB, "1D721502")  // _SUB: Subsystem ID
                Name (_UID, 0x02)  // _UID: Unique ID
                Name (_PR0, Package (0x01)  // _PR0: Power Resources for D0
                {
                    CLK3
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    If (((OSID == One) && ((BDID == 0x09) || (BDID == 0x0A))))
                    {
                        Return (WBUF) /* \_SB_.PCI0.I2C2.RTK3._CRS.WBUF */
                    }

                    Return (SBUF) /* \_SB_.PCI0.I2C2.RTK3._CRS.SBUF */
                }
                        ...
                        Switch (Arg2)
                        {
                            Case (0x03)
                            {
                                Switch (Arg3)
                                {
                                    ...
                                    Case (0x11)
                                    {
                                        Return (Buffer (0x13F5)
                                        {
                                            /* 0000 */  0x50, 0x4D, 0x31, 0x5F, 0x30, 0x30, 0xF5, 0x13,  // PM1_00..
                                            /* 0008 */  0x00, 0x00, 0xE5, 0xFE, 0x89, 0x9D, 0x00, 0x00,  // ........
                                            /* 0010 */  0x58, 0x69, 0x61, 0x6F, 0x6D, 0x69, 0x00, 0x00,  // Xiaomi..
                                            /* 0018 */  0x41, 0x33, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // A3......
                                            /* 0020 */  0x53, 0x74, 0x65, 0x72, 0x65, 0x6F, 0x5F, 0x39,  // Stereo_9
                                            /* 0028 */  0x02, 0x00, 0x06, 0x00, 0x38, 0x00, 0x00, 0x00,  // ....8...
                                            /* 0030 */  0x70, 0x00, 0x00, 0x00, 0xA5, 0xA5, 0xA5, 0x06,  // p.......
                                            /* 0038 */  0x0B, 0x01, 0x36, 0x00, 0x00, 0x00, 0x00, 0x00,  // ..6.....
                                            /* 0040 */  0x48, 0x01, 0x00, 0x03, 0x01, 0x00, 0x91, 0x89,  // H.......
                                            /* 0048 */  0x01, 0x00, 0x31, 0x84, 0x02, 0x00, 0x02, 0x8A,  // ..1.....
                                            /* 0050 */  0x01, 0x00, 0x32, 0x8A, 0x01, 0x00, 0x50, 0x84,  // ..2...P.
                                            /* 0058 */  0x4D, 0x01, 0x00, 0x05, 0x10, 0x0A, 0x00, 0x04,  // M.......
                                            /* 0060 */  0xF9, 0x0A, 0x00, 0x04, 0xA8, 0x00, 0x00, 0x01,  // ........
                                            /* 0068 */  0xC4, 0x00, 0x00, 0x01, 0xE0, 0x00, 0x00, 0x01,  // ........
                                            /* 0070 */  0x0B, 0x01, 0x37, 0x00, 0x00, 0x00, 0x00, 0x00,  // ..7.....
                                            /* 0078 */  0x0A, 0x0D, 0x00, 0x03, 0x01, 0x00, 0x91, 0x89,  // ........
                                            /* 0080 */  0x02, 0x00, 0x31, 0x84, 0x02, 0x00, 0x02, 0x8A,  // ..1.....
                                            /* 0088 */  0x01, 0x00, 0x32, 0x8A, 0x01, 0x00, 0x50, 0x84,  // ..2...P.
                                            /* 0090 */  0x4D, 0x01, 0x00, 0x05, 0x10, 0x0D, 0x00, 0x04,  // M.......
                                            /* 0098 */  0xF8, 0x0D, 0x00, 0x04, 0xF4, 0x00, 0x00, 0x01,  // ........
                                            /* 00A0 */  0x10, 0x01, 0x00, 0x01, 0x2C, 0x01, 0x00, 0x01,  // ....,...
                                            /* 00A8 */  0x06, 0x34, 0x12, 0x00, 0x08, 0x10, 0x00, 0x03,  // .4......
                                            /* 00B0 */  0x08, 0x00, 0xC3, 0x84, 0x00, 0x00, 0xB0, 0x84,  // ........
                                            /* 00B8 */  0x00, 0x00, 0x91, 0x8A, 0x02, 0x00, 0x61, 0x84,  // ......a.
                                            /* 00C0 */  0x0F, 0x10, 0x00, 0x04, 0x06, 0x34, 0x12, 0x00,  // .....4..
                                            /* 00C8 */  0xEF, 0x11, 0x00, 0x03, 0x08, 0x00, 0xC3, 0x84,  // ........
                                            /* 00D0 */  0x01, 0x00, 0xB0, 0x84, 0x00, 0x00, 0x91, 0x8A,  // ........
                                            /* 00D8 */  0x02, 0x00, 0x61, 0x84, 0x0F, 0x10, 0x00, 0x04,  // ..a.....
                                            /* 00E0 */  0x04, 0x34, 0x12, 0x00, 0xF7, 0x11, 0x00, 0x03,  // .4......
                                            /* 00E8 */  0x08, 0x00, 0xC3, 0x84, 0x02, 0x00, 0x91, 0x8A,  // ........
                                            /* 00F0 */  0x00, 0x00, 0x61, 0x84, 0x06, 0x34, 0x12, 0x00,  // ..a..4..
                                            /* 00F8 */  0xFF, 0x11, 0x00, 0x03, 0x08, 0x00, 0xC3, 0x84,  // ........
                                            /* 0100 */  0x00, 0x00, 0xB0, 0x84, 0x00, 0x00, 0x91, 0x8A,  // ........
                                            /* 0108 */  0x02, 0x00, 0x61, 0x84, 0x06, 0x12, 0x00, 0x04,  // ..a.....
                                            /* 0110 */  0x06, 0x34, 0x12, 0x00, 0xE5, 0x13, 0x00, 0x03,  // .4......
                                            /* 0118 */  0x08, 0x00, 0xC3, 0x84, 0x01, 0x00, 0xB0, 0x84,  // ........
                                            /* 0120 */  0x00, 0x00, 0x91, 0x8A, 0x02, 0x00, 0x61, 0x84,  // ......a.
                                            /* 0128 */  0x06, 0x12, 0x00, 0x04, 0x04, 0x34, 0x12, 0x00,  // .....4..
                                            /* 0130 */  0xED, 0x13, 0x00, 0x03, 0x08, 0x00, 0xC3, 0x84,  // ........
                                            /* 0138 */  0x02, 0x00, 0x91, 0x8A, 0x01, 0x00, 0x61, 0x84,  // ......a.
                                            /* 0140 */  0x55, 0x55, 0x55, 0x06, 0x00, 0x00, 0x00, 0x00,  // UUU.....
                                            /* 0148 */  0x6C, 0x65, 0x66, 0x74, 0x00, 0xF7, 0x09, 0x00,  // left....
                                            /* 0150 */  0x03, 0xA2, 0x08, 0x00, 0x00, 0x50, 0x41, 0x31,  // .....PA1
                                            /* 0158 */  0x5F, 0x30, 0x30, 0xA2, 0x08, 0x6D, 0x8A, 0xA3,  // _00..m..
                                            /* 0160 */  0x5B, 0x4E, 0x58, 0x50, 0x00, 0x00, 0x00, 0x00,  // [NXP....
                                            /* 0168 */  0x00, 0x64, 0x65, 0x76, 0x6B, 0x69, 0x74, 0x00,  // .devkit.
                                            /* 0170 */  0x00, 0x73, 0x65, 0x6C, 0x74, 0x65, 0x63, 0x68,  // .seltech
                                            /* 0178 */  0x00, 0x80, 0x20, 0xC6, 0x00, 0x00, 0x31, 0x03,  // .. ...1.
                                            /* 0180 */  0x00, 0x70, 0x00, 0x01, 0xFB, 0x00, 0x71, 0x40,  // .p....q@
                                            /* 0188 */  0x00, 0x61, 0x48, 0x7D, 0x2E, 0x3A, 0x9A, 0x00,  // .aH}.:..
                                            /* 0190 */  0xCA, 0x69, 0x7C, 0x55, 0xF7, 0x6A, 0x7B, 0x55,  // .i|U.j{U
                                            /* 0198 */  0x75, 0x6C, 0x3D, 0x54, 0x79, 0x3B, 0x80, 0x18,  // ul=Ty;..
                                            /* 01A0 */  0x98, 0xB5, 0x00, 0x62, 0x4A, 0x9B, 0xA2, 0xD4,  // ...bJ...
                                            /* 01A8 */  0xB5, 0x61, 0x81, 0x78, 0x0B, 0xA2, 0x1A, 0xF8,  // .a.x....
                                            /* 01B0 */  0x4A, 0x3B, 0x46, 0x40, 0x10, 0x6A, 0x3D, 0xD4,  // J;F@.j=.
                                            /* 01B8 */  0xFC, 0x6A, 0x1B, 0x54, 0xBC, 0x3B, 0x80, 0x15,  // .j.T.;..
                                            /* 01C0 */  0x41, 0xB5, 0x00, 0x42, 0x88, 0xB5, 0x00, 0x54,  // A..B...T
                                            /* 01C8 */  0x3B, 0x7C, 0x44, 0xD4, 0xB8, 0x61, 0xC0, 0x42,  // ;|D..a.B
                                            /* 01D0 */  0x91, 0x6A, 0xBE, 0xD4, 0xB6, 0x3B, 0x80, 0x02,  // .j...;..
                                            /* 01D8 */  0x4B, 0x9B, 0xC3, 0x62, 0x09, 0x6A, 0xDD, 0xD4,  // K..b.j..
                                            /* 01E0 */  0x3D, 0x3A, 0x90, 0x00, 0x25, 0x61, 0xCC, 0x42,  // =:..%a.B
                                            /* 01E8 */  0x80, 0x6A, 0xBE, 0xD4, 0xB9, 0x3B, 0x80, 0x02,  // .j...;..
                                            /* 01F0 */  0x4B, 0x9B, 0xC3, 0x62, 0x09, 0x9B, 0xA0, 0xD4,  // K..b....
                                            /* 01F8 */  0x3B, 0x3A, 0x88, 0x00, 0x96, 0x66, 0x04, 0x45,  // ;:...f.E
                                            /* 0200 */  0x0A, 0x79, 0x40, 0xC3, 0x80, 0x3A, 0x89, 0xFF,  // .y@..:..
                                            /* 0208 */  0x6B, 0x80, 0x18, 0x54, 0x39, 0xB5, 0x00, 0x54,  // k..T9..T
                                            /* 0210 */  0xFB, 0x3B, 0x80, 0x04, 0x39, 0x80, 0xD4, 0x74,  // .;..9..t
                                            /* 0218 */  0x55, 0x7F, 0x4E, 0x54, 0xBB, 0x6A, 0x5C, 0xC2,  // U.NT.j\.
                                            /* 0220 */  0x88, 0x3B, 0x80, 0x02, 0x9C, 0x3C, 0xC8, 0xFF,  // .;...<..
                                            /* 0228 */  0xD5, 0x7F, 0x4E, 0x54, 0x3B, 0xB5, 0x00, 0x43,  // ..NT;..C
                                            /* 0230 */  0x00, 0x38, 0x12, 0x00, 0xCF, 0x38, 0x20, 0x00,  // .8...8 .
                                            /* 0238 */  0xA2, 0xB5, 0x00, 0x76, 0x08, 0x3B, 0x80, 0x02,  // ...v.;..
                                            /* 0240 */  0xCD, 0x9B, 0xA2, 0x74, 0x55, 0x7F, 0x4E, 0x54,  // ...tU.NT
                                            /* 0248 */  0x3B, 0xB5, 0x00, 0x43, 0x00, 0x3A, 0x90, 0x00,  // ;..C.:..
                                            /* 0250 */  0xC8, 0x6A, 0xBD, 0xF4, 0x55, 0xB5, 0x00, 0x62,  // .j..U..b
                                            /* 0258 */  0x09, 0x30, 0xB0, 0x02, 0x7E, 0x30, 0x50, 0x00,  // .0..~0P.
                                            /* 0260 */  0x80, 0x3B, 0x80, 0x04, 0x55, 0x30, 0xA0, 0x0E,  // .;..U0..
                                            /* 0268 */  0x00, 0x7F, 0x4E, 0x54, 0x3D, 0xB5, 0x00, 0x43,  // ..NT=..C
                                            /* 0270 */  0x00, 0x90, 0xDB, 0x54, 0xBB, 0x61, 0x44, 0x7E,  // ...T.aD~
                                            /* 0278 */  0x9C, 0xA2, 0x17, 0x7E, 0x9C, 0x3B, 0x43, 0x40,  // ...~.;C@
                                            /* 0280 */  0xA6, 0xFB, 0x00, 0x71, 0x40, 0x3E, 0x3A, 0x89,  // ...q@>:.
                                            /* 0288 */  0xFF, 0x36, 0xB5, 0x00, 0x54, 0xFE, 0x38, 0x12,  // .6..T.8.
                                            /* 0290 */  0x02, 0x7E, 0x30, 0x60, 0x00, 0x80, 0x30, 0x80,  // .~0`..0.
                                            /* 0298 */  0x0E, 0x00, 0x30, 0xA0, 0x01, 0x80, 0x3B, 0x80,  // ..0...;.
                                            /* 02A0 */  0x02, 0xB8, 0xB5, 0x00, 0x61, 0x46, 0x30, 0x80,  // ....aF0.
                                            /* 02A8 */  0x01, 0x00, 0x30, 0x50, 0x01, 0x00, 0x30, 0x70,  // ..0P..0p
                                            /* 02B0 */  0x00, 0x80, 0x3B, 0x80, 0x00, 0x48, 0x38, 0x0C,  // ..;..H8.
                                            /* 02B8 */  0x02, 0xFF, 0x30, 0x90, 0x01, 0x80, 0x38, 0x0A,  // ..0...8.
                                            /* 02C0 */  0x20, 0x01, 0x20, 0x80, 0x40, 0x52, 0x30, 0x80,  //  . .@R0.
                                            /* 02C8 */  0x01, 0x00, 0xB5, 0x00, 0x42, 0x01, 0xB5, 0x00,  // ....B...
                                            /* 02D0 */  0x43, 0x08, 0xD4, 0xC8, 0x42, 0x01, 0x60, 0x24,  // C...B.`$
                                            /* 02D8 */  0xFE, 0x9C, 0x30, 0x90, 0x01, 0x00, 0x30, 0x50,  // ..0...0P
                                            /* 02E0 */  0x00, 0x80, 0x30, 0xA0, 0x20, 0x3E, 0x3B, 0x80,  // ..0. >;.
                                            /* 02E8 */  0x04, 0x0A, 0x30, 0x80, 0x01, 0x80, 0x30, 0x80,  // ..0...0.
                                            /* 02F0 */  0x01, 0x00, 0x30, 0x50, 0x00, 0x80, 0x3B, 0x80,  // ..0P..;.
                                            /* 02F8 */  0x02, 0x5F, 0x30, 0x90, 0x01, 0x00, 0xB5, 0x00,  // ._0.....
                                            /* 0300 */  0x54, 0xB5, 0x3A, 0x89, 0x00, 0x87, 0xB5, 0x00,  // T.:.....
                                            /* 0308 */  0x42, 0x88, 0x82, 0x14, 0x7E, 0x9C, 0x3B, 0x65,  // B...~.;e
                                            /* 0310 */  0x40, 0x64, 0x34, 0x00, 0x0E, 0x8D, 0x3B, 0x00,  // @d4...;.
                                            /* 0318 */  0x40, 0xA6, 0x34, 0x00, 0x0E, 0x8E, 0x30, 0x80,  // @.4...0.
                                            /* 0320 */  0x01, 0x00, 0x30, 0xA0, 0x01, 0x80, 0x30, 0x50,  // ..0...0P
                                            /* 0328 */  0x00, 0x40, 0x3B, 0x80, 0x03, 0x35, 0x3A, 0x88,  // .@;..5:.
                                            /* 0330 */  0x00, 0x01, 0x38, 0x08, 0x20, 0x00, 0x30, 0x90,  // ..8. .0.
                                            /* 0338 */  0x01, 0x00, 0x30, 0x60, 0x00, 0x3F, 0x20, 0x3F,  // ..0`.? ?
                                            /* 0340 */  0x40, 0x74, 0x38, 0x0A, 0x20, 0x00, 0x8B, 0xE0,  // @t8. ...
                                            /* 0348 */  0x7B, 0x00, 0xB5, 0x00, 0x40, 0x09, 0xA2, 0x10,  // {...@...
                                            /* 0350 */  0x7E, 0x9C, 0x3B, 0x67, 0x40, 0x73, 0x80, 0x80,  // ~.;g@s..
                                            /* 0358 */  0x64, 0x07, 0x90, 0xFC, 0xFE, 0x9C, 0xB5, 0x00,  // d.......
                                            /* 0360 */  0x7E, 0x9C, 0x69, 0x3F, 0xE1, 0x10, 0x30, 0x90,  // ~.i?..0.
                                            /* 0368 */  0x01, 0x80, 0xB5, 0x00, 0x76, 0x48, 0x3B, 0x80,  // ....vH;.
                                            /* 0370 */  0x02, 0x58, 0xB0, 0xDA, 0x62, 0x09, 0x3A, 0x20,  // .X..b.: 
                                            /* 0378 */  0xFF, 0xFF, 0xB5, 0x00, 0x7A, 0x40, 0xFB, 0x00,  // ....z@..
                                            /* 0380 */  0x71, 0x40, 0x7C, 0x30, 0x80, 0x01, 0x00, 0x20,  // q@|0... 
                                            /* 0388 */  0x3F, 0x40, 0x81, 0x30, 0x90, 0x01, 0x80, 0x80,  // ?@.0....
                                            /* 0390 */  0x68, 0x40, 0x09, 0xB2, 0x08, 0x7E, 0x9C, 0xA0,  // h@...~..
                                            /* 0398 */  0x6C, 0x40, 0x09, 0xB5, 0x00, 0x76, 0x40, 0x38,  // l@...v@8
                                            /* 03A0 */  0x6C, 0x20, 0x00, 0x3C, 0xD8, 0x06, 0x04, 0x20,  // l .<... 
                                            /* 03A8 */  0x17, 0x40, 0x88, 0x9B, 0xA4, 0xC3, 0x08, 0xA6,  // .@......
                                            /* 03B0 */  0xBA, 0xFE, 0x9C, 0xB4, 0x4A, 0xFE, 0x9C, 0x9B,  // ....J...
                                            /* 03B8 */  0xC7, 0xE1, 0x76, 0xB5, 0x00, 0x61, 0x03, 0xD0,  // ..v..a..
                                            /* 03C0 */  0x24, 0x74, 0x12, 0x30, 0xA0, 0x0E, 0x8F, 0xA4,  // $t.0....
                                            /* 03C8 */  0x03, 0x62, 0x4A, 0x38, 0x0A, 0x0E, 0x83, 0x38,  // .bJ8...8
                                            /* 03D0 */  0x0C, 0x0E, 0x82, 0x3B, 0x80, 0x02, 0x2B, 0x9B,  // ...;..+.
                                            /* 03D8 */  0xE0, 0xD0, 0x52, 0x38, 0x0A, 0x0E, 0x85, 0x38,  // ..R8...8
                                            /* 03E0 */  0x0C, 0x0E, 0x84, 0x30, 0xA0, 0x0E, 0x90, 0xB5,  // ...0....
                                            /* 03E8 */  0x00, 0x74, 0x12, 0x3B, 0x80, 0x02, 0x2B, 0x9B,  // .t.;..+.
                                            /* 03F0 */  0xE0, 0xE2, 0x4A, 0x38, 0x0A, 0x0E, 0x8F, 0x38,  // ..J8...8
                                            /* 03F8 */  0x0C, 0x0E, 0x86, 0xA2, 0x17, 0x7E, 0x9C, 0x3B,  // .....~.;
                                            /* 0400 */  0x64, 0x40, 0x9E, 0x3B, 0x00, 0x40, 0x9F, 0x34,  // d@.;.@.4
                                            /* 0408 */  0x00, 0x0E, 0x8D, 0x34, 0x01, 0x0E, 0x8D, 0x38,  // ...4...8
                                            /* 0410 */  0x0A, 0x0E, 0x90, 0x38, 0x0C, 0x0E, 0x87, 0xA2,  // ...8....
                                            /* 0418 */  0x17, 0x7E, 0x9C, 0x3B, 0x64, 0x40, 0xA5, 0x3B,  // .~.;d@.;
                                            /* 0420 */  0x00, 0x40, 0xA6, 0x34, 0x00, 0x0E, 0x8E, 0x34,  // .@.4...4
                                            /* 0428 */  0x01, 0x0E, 0x8E, 0x3B, 0x80, 0x05, 0xB6, 0xB5,  // ...;....
                                            /* 0430 */  0x00, 0x7E, 0x9C, 0x7F, 0x4E, 0x54, 0xBE, 0xB5,  // .~..NT..
                                            /* 0438 */  0x00, 0x44, 0x88, 0x38, 0x0C, 0x0E, 0x8D, 0x38,  // .D.8...8
                                            /* 0440 */  0x0E, 0x0E, 0x81, 0x38, 0x00, 0x0E, 0x80, 0x82,  // ...8....
                                            /* 0448 */  0x18, 0x7E, 0x9C, 0x3A, 0x81, 0x00, 0x29, 0x3B,  // .~.:..);
                                            /* 0450 */  0x43, 0x40, 0xBF, 0x38, 0x0C, 0x0E, 0x8C, 0x9B,  // C@.8....
                                            /* 0458 */  0xBF, 0xD5, 0x37, 0xA2, 0x13, 0xFE, 0x9C, 0x3B,  // ..7....;
                                            /* 0460 */  0x64, 0x40, 0xBF, 0xA2, 0x10, 0x7E, 0x9C, 0x3B,  // d@...~.;
                                            /* 0468 */  0x67, 0x40, 0xBF, 0x38, 0x08, 0x0E, 0x88, 0xD0,  // g@.8....
                                            /* 0470 */  0x45, 0x54, 0xB5, 0x3A, 0x89, 0x00, 0x50, 0xB5,  // ET.:..P.
                                            /* 0478 */  0x00, 0x12, 0x61, 0xFB, 0x00, 0x71, 0x40, 0xBA,  // ..a..q@.
                                            /* 0480 */  0x38, 0x0E, 0x02, 0x7F, 0x95, 0xD8, 0xC3, 0xC0,  // 8.......
                                            /* 0488 */  0xB3, 0xD3, 0x7E, 0x9C, 0x3B, 0x00, 0x40, 0xCE,  // ..~.;.@.
                                            /* 0490 */  0x38, 0x0D, 0x0E, 0x8C, 0x38, 0x02, 0x0E, 0x8E,  // 8...8...
                                            /* 0498 */  0x82, 0x04, 0x7E, 0x9C, 0x3B, 0x43, 0x40, 0xC7,  // ..~.;C@.
                                            /* 04A0 */  0x7F, 0x20, 0x42, 0xD0, 0xA2, 0x13, 0xFE, 0x9C,  // . B.....
                                            /* 04A8 */  0x3B, 0x64, 0x40, 0xC7, 0xA2, 0x10, 0x7E, 0x9C,  // ;d@...~.
                                            /* 04B0 */  0x3B, 0x66, 0x40, 0xCE, 0x38, 0x08, 0x0E, 0x89,  // ;f@.8...
                                            /* 04B8 */  0xD0, 0x44, 0x7E, 0x9C, 0x38, 0x0C, 0x0E, 0x8A,  // .D~.8...
                                            /* 04C0 */  0xB5, 0x00, 0x61, 0x00, 0x95, 0x90, 0xFE, 0x9C,  // ..a.....
                                            /* 04C8 */  0xB2, 0xDA, 0x7E, 0x9C, 0x38, 0x0D, 0x0E, 0x8C,  // ..~.8...
                                            /* 04D0 */  0x6A, 0x1D, 0xD4, 0xBD, 0x61, 0x00, 0x43, 0x08,  // j...a.C.
                                            /* 04D8 */  0xA2, 0x13, 0x7E, 0x9C, 0x3A, 0x89, 0xFF, 0xEB,  // ..~.:...
                                            /* 04E0 */  0x3B, 0x46, 0x40, 0xD6, 0xB5, 0x00, 0x54, 0xF7,  // ;F@...T.
                                            /* 04E8 */  0x3A, 0x88, 0xFF, 0x93, 0xB5, 0x00, 0x42, 0xD0,  // :.....B.
                                            /* 04F0 */  0xB5, 0x00, 0x42, 0x88, 0x82, 0x14, 0x54, 0x35,  // ..B...T5
                                            /* 04F8 */  0x3A, 0x80, 0x00, 0x5D, 0x3A, 0x89, 0xFF, 0xA5,  // :..]:...
                                            /* 0500 */  0xB5, 0x00, 0x55, 0x3C, 0x3B, 0x43, 0x40, 0xEB,  // ..U<;C@.
                                            /* 0508 */  0x6A, 0x3E, 0x54, 0xFB, 0x3A, 0x82, 0x00, 0x98,  // j>T.:...
                                            /* 0510 */  0x9B, 0xA0, 0xF8, 0x45, 0x31, 0x1F, 0xFF, 0x69,  // ...E1..i
                                            /* 0518 */  0x61, 0xC8, 0x4C, 0x0D, 0x6A, 0x7E, 0xC5, 0x00,  // a.L.j~..
                                            /* 0520 */  0x6A, 0x1B, 0x72, 0x81, 0xB5, 0x00, 0x74, 0x55,  // j.r...tU
                                            /* 0528 */  0x3B, 0x80, 0x04, 0x39, 0x80, 0x18, 0x61, 0x85,  // ;..9..a.
                                            /* 0530 */  0x6A, 0x5C, 0xD5, 0x3D, 0x3B, 0x80, 0x1A, 0xF0,  // j\.=;...
                                            /* 0538 */  0x3C, 0xC8, 0xFF, 0xD5, 0x3B, 0x00, 0x40, 0xEC,  // <...;.@.
                                            /* 0540 */  0xB5, 0x00, 0x54, 0xB7, 0xB5, 0x00, 0x54, 0xB7,  // ..T...T.
                                            /* 0548 */  0x61, 0x44, 0x7E, 0x9C, 0x98, 0xB5, 0x54, 0xBB,  // aD~...T.
                                            /* 0550 */  0xB5, 0x00, 0x7E, 0x9C, 0x82, 0x14, 0x43, 0x08,  // ..~...C.
                                            /* 0558 */  0x3B, 0x63, 0x40, 0xF5, 0xB5, 0x00, 0x54, 0x36,  // ;c@...T6
                                            /* 0560 */  0x3B, 0x80, 0x02, 0x9C, 0x80, 0xB8, 0x74, 0x55,  // ;.....tU
                                            /* 0568 */  0x3B, 0x20, 0x40, 0xFE, 0x6A, 0x1A, 0xD4, 0xB8,  // ; @.j...
                                            /* 0570 */  0x3A, 0x89, 0x00, 0x22, 0x3A, 0x80, 0x00, 0x14,  // :..":...
                                            /* 0578 */  0xFB, 0x00, 0x71, 0x40, 0xF8, 0x61, 0x04, 0x42,  // ..q@.a.B
                                            /* 0580 */  0x80, 0xD0, 0x0C, 0x74, 0x55, 0x30, 0xA0, 0x07,  // ...tU0..
                                            /* 0588 */  0x6C, 0x94, 0x03, 0xD4, 0x36, 0x3B, 0x80, 0x01,  // l...6;..
                                            /* 0590 */  0xC7, 0xB5, 0x00, 0x61, 0x40, 0x9B, 0xA0, 0xD4,  // ...a@...
                                            /* 0598 */  0xBB, 0x3A, 0x81, 0x00, 0x97, 0x61, 0xC4, 0x45,  // .:...a.E
                                            /* 05A0 */  0x04, 0x31, 0x0F, 0xFF, 0x69, 0x6A, 0x3B, 0xCC,  // .1..ij;.
                                            /* 05A8 */  0x05, 0x6A, 0x5B, 0x72, 0x81, 0xB5, 0x00, 0x74,  // .j[r...t
                                            /* 05B0 */  0x15, 0x3B, 0x80, 0x04, 0x39, 0x80, 0x18, 0x61,  // .;..9..a
                                            /* 05B8 */  0x85, 0x6A, 0x5C, 0xD5, 0x37, 0xB5, 0x00, 0x54,  // .j\.7..T
                                            /* 05C0 */  0x36, 0x3B, 0x80, 0x19, 0x9A, 0xB5, 0x00, 0x7E,  // 6;.....~
                                            /* 05C8 */  0x9C, 0x92, 0x13, 0xFE, 0x9C, 0x3B, 0x62, 0x41,  // .....;bA
                                            /* 05D0 */  0x2A, 0x8B, 0x80, 0x54, 0xBC, 0x3A, 0x81, 0xFF,  // *..T.:..
                                            /* 05D8 */  0xF1, 0x60, 0x08, 0x78, 0x81, 0x38, 0x0A, 0x0E,  // .`.x.8..
                                            /* 05E0 */  0x8C, 0xB5, 0x00, 0x4A, 0x00, 0xB3, 0x02, 0xC3,  // ...J....
                                            /* 05E8 */  0x08, 0x90, 0xDB, 0xCA, 0x40, 0x3A, 0x9A, 0x00,  // ....@:..
                                            /* 05F0 */  0x11, 0xB2, 0xD3, 0x42, 0x98, 0x92, 0x17, 0xC3,  // ...B....
                                            /* 05F8 */  0x48, 0xB5, 0x00, 0x48, 0x50, 0x3B, 0x42, 0x41,  // H..HP;BA
                                            /* 0600 */  0x28, 0xB5, 0x00, 0x54, 0x35, 0x3A, 0x98, 0x00,  // (..T5:..
                                            /* 0608 */  0x5E, 0xB5, 0x00, 0x43, 0x18, 0x82, 0x18, 0x7E,  // ^..C...~
                                            /* 0610 */  0x9C, 0x3B, 0x66, 0x41, 0x28, 0x3A, 0x88, 0x00,  // .;fA(:..
                                            /* 0618 */  0x5F, 0xB5, 0x00, 0x43, 0x08, 0x90, 0xD8, 0xFE,  // _..C....
                                            /* 0620 */  0x9C, 0xA2, 0x1A, 0xC3, 0x48, 0x3B, 0x66, 0x41,  // ....H;fA
                                            /* 0628 */  0x26, 0x6C, 0x1D, 0x7E, 0x4A, 0x3B, 0x00, 0x41,  // &l.~J;.A
                                            /* 0630 */  0x2B, 0xB5, 0x00, 0x7E, 0x48, 0x3B, 0x00, 0x41,  // +..~H;.A
                                            /* 0638 */  0x2B, 0xB5, 0x00, 0x58, 0x3A, 0x3B, 0x00, 0x41,  // +..X:;.A
                                            /* 0640 */  0x2B, 0xB5, 0x00, 0x58, 0x3A, 0x9B, 0x9F, 0xD8,  // +..X:...
                                            /* 0648 */  0x3A, 0x3C, 0xD8, 0x03, 0x00, 0x7F, 0x4E, 0x7D,  // :<....N}
                                            /* 0650 */  0x52, 0x61, 0x40, 0x7D, 0x04, 0x3A, 0x88, 0x00,  // Ra@}.:..
                                            /* 0658 */  0x39, 0x6A, 0x3F, 0x52, 0xFD, 0xB5, 0x00, 0x58,  // 9j?R...X
                                            /* 0660 */  0x7F, 0x3B, 0x80, 0x11, 0x2E, 0xB5, 0x00, 0x54,  // .;.....T
                                            /* 0668 */  0xFC, 0xB5, 0x00, 0x54, 0x3D, 0x3A, 0x80, 0x00,  // ...T=:..
                                            /* 0670 */  0x0F, 0xB5, 0x00, 0x42, 0x00, 0xFB, 0x00, 0x71,  // ...B...q
                                            /* 0678 */  0x41, 0x36, 0x3A, 0x88, 0x00, 0x1A, 0x3B, 0x80,  // A6:...;.
                                            /* 0680 */  0x03, 0x52, 0x8B, 0xA0, 0x54, 0xFD, 0x9B, 0xA8,  // .R..T...
                                            /* 0688 */  0xD4, 0xBC, 0xA4, 0x02, 0xD4, 0x3E, 0x3B, 0x80,  // .....>;.
                                            /* 0690 */  0x10, 0x9B, 0xB5, 0x00, 0x40, 0x48, 0xB5, 0x00,  // ....@H..
                                            /* 0698 */  0x54, 0x3E, 0x3B, 0x80, 0x12, 0x65, 0xB5, 0x00,  // T>;..e..
                                            /* 06A0 */  0x7E, 0x9C, 0x9B, 0xA7, 0xD4, 0x3E, 0x9B, 0x8B,  // ~....>..
                                            /* 06A8 */  0xF8, 0x03, 0xB5, 0x00, 0x43, 0x00, 0xD0, 0x4C,  // ....C..L
                                            /* 06B0 */  0x54, 0xBD, 0x38, 0x02, 0x02, 0x7F, 0xA5, 0x82,  // T.8.....
                                            /* 06B8 */  0x40, 0xC8, 0x38, 0x00, 0x0E, 0x8B, 0x3A, 0x80,  // @.8...:.
                                            /* 06C0 */  0x00, 0x9E, 0x73, 0x82, 0x4C, 0x80, 0x38, 0x01,  // ..s.L.8.
                                            /* 06C8 */  0x0E, 0x8C, 0x31, 0x80, 0x23, 0xED, 0x3B, 0x80,  // ..1.#.;.
                                            /* 06D0 */  0x02, 0xA3, 0xB5, 0x00, 0x7E, 0x00, 0xB5, 0x00,  // ....~...
                                            /* 06D8 */  0x58, 0x3F, 0x3C, 0xD8, 0x03, 0x00, 0x8B, 0x80,  // X?<.....
                                            /* 06E0 */  0x7D, 0x7C, 0xB5, 0x00, 0x7E, 0x9C, 0x6A, 0xFC,  // }|..~.j.
                                            /* 06E8 */  0x7D, 0x29, 0x3A, 0xA3, 0x00, 0x38, 0x6A, 0x7D,  // }):..8j}
                                            /* 06F0 */  0xC6, 0x9B, 0x3A, 0xAD, 0x00, 0x05, 0x6A, 0xFD,  // ..:...j.
                                            /* 06F8 */  0x56, 0xF9, 0x3A, 0xAD, 0x00, 0x04, 0xB5, 0x00,  // V.:.....
                                            /* 0700 */  0x42, 0xA8, 0x82, 0x14, 0x56, 0x7C, 0x6C, 0x3F,  // B...V|l?
                                            /* 0708 */  0x55, 0x7D, 0xB5, 0x00, 0x74, 0x58, 0x3B, 0x42,  // U}..tX;B
                                            /* 0710 */  0x41, 0x61, 0xB5, 0x00, 0x42, 0x98, 0x3A, 0x9D,  // Aa..B.:.
                                            /* 0718 */  0x00, 0x11, 0x3B, 0x80, 0x02, 0x9C, 0xB5, 0x00,  // ..;.....
                                            /* 0720 */  0x55, 0xFF, 0x3B, 0x20, 0x41, 0x67, 0x9B, 0xC3,  // U.; Ag..
                                            /* 0728 */  0xD4, 0x38, 0x3A, 0x80, 0x00, 0x29, 0x3A, 0x90,  // .8:..):.
                                            /* 0730 */  0x00, 0x10, 0x6A, 0xFF, 0xC4, 0x00, 0x3B, 0x80,  // ..j...;.
                                            /* 0738 */  0x02, 0x4B, 0x80, 0xF4, 0x42, 0x90, 0x6A, 0x5E,  // .K..B.j^
                                            /* 0740 */  0xD5, 0x38, 0x3B, 0x80, 0x18, 0x74, 0x3C, 0xC8,  // .8;..t<.
                                            /* 0748 */  0xFF, 0xD8, 0x9B, 0x00, 0xD4, 0xBA, 0x3A, 0x81,  // ......:.
                                            /* 0750 */  0x00, 0x94, 0x80, 0xA0, 0x45, 0x02, 0x66, 0x00,  // ....E.f.
                                            /* 0758 */  0x43, 0x88, 0x3A, 0x98, 0xFF, 0x7E, 0x6A, 0x1E,  // C.:..~j.
                                            /* 0760 */  0xD4, 0xBB, 0x3B, 0x80, 0x04, 0x39, 0x80, 0xD4,  // ..;..9..
                                            /* 0768 */  0x55, 0xFA, 0x6B, 0x1F, 0xD4, 0xBA, 0x3A, 0xB1,  // U.k...:.
                                            /* 0770 */  0x00, 0x1B, 0xFB, 0x00, 0x71, 0x41, 0x74, 0x30,  // ....qAt0
                                            /* 0778 */  0x50, 0x66, 0x66, 0x7C, 0x5A, 0xD2, 0xD7, 0x69,  // Pff|Z..i
                                            /* 0780 */  0xCB, 0xC0, 0x20, 0x30, 0x40, 0x4C, 0xCD, 0x3A,  // .. 0@L.:
                                            /* 0788 */  0x82, 0x00, 0x3A, 0x31, 0x0F, 0xFF, 0x9D, 0xB3,  // ..:1....
                                            /* 0790 */  0x02, 0x43, 0x10, 0x95, 0xFF, 0x42, 0x85, 0x90,  // .C...B..
                                            /* 0798 */  0xDB, 0xC2, 0x08, 0xB3, 0x93, 0xD7, 0xB9, 0xB5,  // ........
                                            /* 07A0 */  0x00, 0x43, 0xB0, 0xA2, 0x1F, 0x40, 0x60, 0x3A,  // .C...@`:
                                            /* 07A8 */  0xBF, 0x00, 0x15, 0x3A, 0x9C, 0xFF, 0xF8, 0x3A,  // ...:...:
                                            /* 07B0 */  0x90, 0x00, 0x35, 0x61, 0x24, 0x43, 0x80, 0x3A,  // ..5a$C.:
                                            /* 07B8 */  0xAA, 0x00, 0x55, 0x6B, 0xFF, 0xD5, 0xFA, 0x3B,  // ..Uk...;
                                            /* 07C0 */  0x44, 0x41, 0x8D, 0x61, 0x94, 0x40, 0x10, 0x82,  // DA.a.@..
                                            /* 07C8 */  0x14, 0x7E, 0x9C, 0x3B, 0x62, 0x41, 0xAF, 0x30,  // .~.;bA.0
                                            /* 07D0 */  0x40, 0x02, 0x00, 0xA2, 0x16, 0x7E, 0x9C, 0x3B,  // @....~.;
                                            /* 07D8 */  0x62, 0x41, 0xAF, 0x82, 0x14, 0x7E, 0x9C, 0x3B,  // bA...~.;
                                            /* 07E0 */  0x62, 0x41, 0x90, 0x3B, 0x20, 0x41, 0x92, 0x82,  // bA.; A..
                                            /* 07E8 */  0x00, 0x7E, 0x9C, 0x3B, 0x63, 0x41, 0x94, 0x3B,  // .~.;cA.;
                                            /* 07F0 */  0x00, 0x41, 0x96, 0xB5, 0x00, 0x54, 0x38, 0x82,  // .A...T8.
                                            /* 07F8 */  0x18, 0x54, 0x38, 0x3B, 0x63, 0x41, 0xAB, 0x3A,  // .T8;cA.:
                                            /* 0800 */  0x88, 0x00, 0x61, 0x61, 0x86, 0xFB, 0x24, 0xB5,  // ..aa..$.
                                            /* 0808 */  0x00, 0x74, 0x18, 0x3B, 0x80, 0x00, 0x48, 0xB5,  // .t.;..H.
                                            /* 0810 */  0x00, 0x54, 0xFC, 0x6A, 0x1F, 0xD4, 0xBC, 0x31,  // .T.j...1
                                            /* 0818 */  0x1F, 0xFF, 0x9D, 0x61, 0x84, 0x42, 0x4D, 0x61,  // ...a.BMa
                                            /* 0820 */  0x40, 0x54, 0xFC, 0xB5, 0x00, 0x74, 0x58, 0x3B,  // @T...tX;
                                            /* 0828 */  0x80, 0x02, 0x58, 0xB5, 0x00, 0x62, 0x09, 0x6A,  // ..X..b.j
                                            /* 0830 */  0x9D, 0xD4, 0xBC, 0x3A, 0x81, 0x00, 0x36, 0x71,  // ...:..6q
                                            /* 0838 */  0x25, 0x42, 0x88, 0xB5, 0x00, 0x54, 0x7B, 0x3B,  // %B...T{;
                                            /* 0840 */  0x80, 0x02, 0x8A, 0x3C, 0xC8, 0xFF, 0xD8, 0x6A,  // ...<...j
                                            /* 0848 */  0x1D, 0xD4, 0xBA, 0x3B, 0x00, 0x41, 0xCB, 0xB5,  // ...;.A..
                                            /* 0850 */  0x00, 0x7E, 0x40, 0x9B, 0xA0, 0xD4, 0xBA, 0xB5,  // .~@.....
                                            /* 0858 */  0x00, 0x54, 0x3C, 0x3B, 0x00, 0x41, 0xCB, 0xB5,  // .T<;.A..
                                            /* 0860 */  0x00, 0x42, 0xC0, 0x9B, 0x4B, 0xD4, 0x38, 0x3A,  // .B..K.8:
                                            /* 0868 */  0x88, 0x00, 0x63, 0x30, 0x50, 0x01, 0x00, 0xBB,  // ..c0P...
                                            /* 0870 */  0x00, 0x71, 0x41, 0xB2, 0xBA, 0xA3, 0xC2, 0xC9,  // .qA.....
                                            /* 0878 */  0x30, 0x40, 0x04, 0x00, 0xBA, 0x22, 0x7E, 0x49,  // 0@..."~I
                                            /* 0880 */  0xB9, 0x60, 0xFE, 0x48, 0x3A, 0x81, 0xFF, 0xF3,  // .`.H:...
                                            /* 0888 */  0xB0, 0x69, 0xD4, 0xBA, 0x7D, 0x82, 0x55, 0x3C,  // .i..}.U<
                                            /* 0890 */  0x3C, 0xD8, 0x06, 0x04, 0x3C, 0xC3, 0x41, 0xBD,  // <...<.A.
                                            /* 0898 */  0xAA, 0xFE, 0x41, 0x01, 0xA6, 0x25, 0xC1, 0x45,  // ..A..%.E
                                            /* 08A0 */  0xB4, 0x26, 0xFE, 0x9C, 0x82, 0x1C, 0x61, 0x75,  // .&....au
                                            /* 08A8 */  0xBF, 0xB2, 0xFE, 0x9C, 0x82, 0x00, 0x7E, 0x9C,  // ......~.
                                            /* 08B0 */  0x95, 0xB5, 0x7E, 0x9C, 0x3B, 0x43, 0x41, 0xC6,  // ..~.;CA.
                                            /* 08B8 */  0x90, 0xB5, 0x7E, 0x9C, 0x9B, 0xE0, 0xC2, 0xC0,  // ..~.....
                                            /* 08C0 */  0x3B, 0x20, 0x41, 0xC8, 0x82, 0x18, 0x7E, 0x9C,  // ; A...~.
                                            /* 08C8 */  0x3B, 0x63, 0x41, 0xCA, 0x3B, 0x00, 0x41, 0xCB,  // ;cA.;.A.
                                            /* 08D0 */  0xB5, 0x00, 0x7E, 0x50, 0xB5, 0x00, 0x43, 0xD0,  // ..~P..C.
                                            /* 08D8 */  0x9B, 0xE4, 0x42, 0x88, 0xA8, 0xB7, 0xFE, 0x9C,  // ..B.....
                                            /* 08E0 */  0x82, 0x14, 0x7E, 0x9C, 0x3B, 0x62, 0x41, 0xDC,  // ..~.;bA.
                                            /* 08E8 */  0x6A, 0x5C, 0xD4, 0x38, 0x3A, 0x80, 0x00, 0x14,  // j\.8:...
                                            /* 08F0 */  0x3A, 0x89, 0x00, 0x1D, 0x61, 0xC4, 0x42, 0x80,  // :...a.B.
                                            /* 08F8 */  0x3A, 0x80, 0xFF, 0xEE, 0xD0, 0x6C, 0x43, 0x00,  // :....lC.
                                            /* 0900 */  0xB5, 0x00, 0x54, 0xBD, 0x94, 0x02, 0x62, 0x09,  // ..T...b.
                                            /* 0908 */  0x30, 0xA0, 0x07, 0xE0, 0x3B, 0x80, 0x01, 0xC7,  // 0...;...
                                            /* 0910 */  0xB5, 0x00, 0x61, 0x40, 0x3B, 0x00, 0x41, 0xDD,  // ..a@;.A.
                                            /* 0918 */  0xB5, 0x00, 0x58, 0x3E, 0xB5, 0x00, 0x58, 0x3E,  // ..X>..X>
                                            /* 0920 */  0x3C, 0xD8, 0x03, 0x00, 0x8B, 0x80, 0x7D, 0x57,  // <.....}W
                                            /* 0928 */  0xB5, 0x00, 0x7E, 0x9C, 0x03, 0x00, 0x70, 0x00,  // ..~...p.
                                            /* 0930 */  0x05, 0x03, 0x00, 0x70, 0x00, 0x07, 0x42, 0x00,  // ...p..B.
                                            /* 0938 */  0x71, 0x03, 0x00, 0x00, 0x00, 0x01, 0x00, 0x0D,  // q.......
                                            /* 0940 */  0x46, 0x00, 0x41, 0x2D, 0x00, 0x3B, 0x80, 0x00,  // F.A-.;..
                                            /* 0948 */  0x00, 0x01, 0x00, 0x0D, 0x6A, 0x00, 0x41, 0x2D,  // ....j.A-
                                            /* 0950 */  0x00, 0x3B, 0x80, 0x00, 0x00, 0x01, 0x00, 0x0D,  // .;......
                                            /* 0958 */  0x9E, 0x00, 0x41, 0x2D, 0x00, 0x3B, 0x80, 0x00,  // ..A-.;..
                                            /* 0960 */  0x00, 0x01, 0x00, 0x0F, 0x74, 0x00, 0x40, 0x00,  // ....t.@.
                                            /* 0968 */  0x00, 0x3B, 0x80, 0x00, 0x00, 0x01, 0x00, 0x0F,  // .;......
                                            /* 0970 */  0x9C, 0x00, 0x41, 0x51, 0x00, 0x3B, 0x80, 0x00,  // ..AQ.;..
                                            /* 0978 */  0x00, 0x00, 0x06, 0x00, 0x71, 0x03, 0x18, 0x00,  // ....q...
                                            /* 0980 */  0x00, 0x00, 0x06, 0x00, 0x71, 0x03, 0x1C, 0x00,  // ....q...
                                            /* 0988 */  0x00, 0x00, 0x06, 0x00, 0x71, 0x03, 0x20, 0x00,  // ....q. .
                                            /* 0990 */  0x00, 0x00, 0x06, 0x00, 0x71, 0x03, 0x24, 0x00,  // ....q.$.
                                            /* 0998 */  0x00, 0x00, 0x03, 0x00, 0x70, 0x00, 0x03, 0x09,  // ....p...
                                            /* 09A0 */  0x00, 0x71, 0x02, 0x7E, 0x00, 0x0E, 0x00, 0x01,  // .q.~....
                                            /* 09A8 */  0x47, 0xAE, 0x06, 0x00, 0x71, 0x02, 0xFF, 0x10,  // G...q...
                                            /* 09B0 */  0x00, 0x00, 0x36, 0x00, 0x71, 0x0E, 0x80, 0x00,  // ..6.q...
                                            /* 09B8 */  0x00, 0x3C, 0x00, 0x00, 0x05, 0x70, 0x05, 0xAD,  // .<...p..
                                            /* 09C0 */  0x7F, 0xD4, 0x56, 0x7F, 0xF7, 0x43, 0x70, 0x05,  // ..V..Cp.
                                            /* 09C8 */  0xAD, 0x06, 0x66, 0x66, 0x19, 0x99, 0x99, 0x40,  // ..ff...@
                                            /* 09D0 */  0x07, 0x93, 0x3F, 0xFF, 0xD0, 0x02, 0xCC, 0xCD,  // ..?.....
                                            /* 09D8 */  0x09, 0x00, 0x00, 0x09, 0x00, 0x00, 0x00, 0x00,  // ........
                                            /* 09E0 */  0x00, 0x00, 0x00, 0x00, 0x7F, 0xFF, 0xFF, 0x7F,  // ........
                                            /* 09E8 */  0xFF, 0xFF, 0x06, 0x00, 0x71, 0x12, 0xBF, 0x02,  // ....q...
                                            /* 09F0 */  0x01, 0x01, 0x03, 0x00, 0x70, 0x00, 0x00, 0x54,  // ....p..T
                                            /* 09F8 */  0x46, 0x41, 0x39, 0x38, 0x39, 0x30, 0x5F, 0x4E,  // FA9890_N
                                            /* 0A00 */  0x31, 0x43, 0x33, 0x5F, 0x32, 0x5F, 0x31, 0x5F,  // 1C3_2_1_
                                            /* 0A08 */  0x31, 0x2E, 0x70, 0x61, 0x74, 0x63, 0x68, 0x00,  // 1.patch.
                                            /* 0A10 */  0xE1, 0x0A, 0x00, 0x03, 0xC9, 0x00, 0x00, 0x00,  // ........
                                            /* 0A18 */  0x43, 0x4F, 0x31, 0x5F, 0x30, 0x31, 0xC9, 0x00,  // CO1_01..
                                            /* 0A20 */  0x5C, 0xBA, 0x3D, 0xDA, 0x4E, 0x58, 0x50, 0x00,  // \.=.NXP.
                                            /* 0A28 */  0x00, 0x00, 0x00, 0x00, 0x64, 0x65, 0x76, 0x6B,  // ....devk
                                            /* 0A30 */  0x69, 0x74, 0x00, 0x00, 0x76, 0x65, 0x72, 0x20,  // it..ver 
                                            /* 0A38 */  0x31, 0x2E, 0x30, 0x00, 0x0F, 0xCC, 0xCD, 0x01,  // 1.0.....
                                            /* 0A40 */  0xF6, 0x66, 0x00, 0x7B, 0x33, 0x00, 0x00, 0x64,  // .f.{3..d
                                            /* 0A48 */  0x00, 0x00, 0x02, 0x1A, 0xFD, 0x2F, 0x1B, 0x58,  // ...../.X
                                            /* 0A50 */  0x10, 0x1C, 0x72, 0x05, 0x00, 0x49, 0x9A, 0x00,  // ..r..I..
                                            /* 0A58 */  0x00, 0x01, 0x00, 0x00, 0x02, 0x00, 0x00, 0x01,  // ........
                                            /* 0A60 */  0x00, 0x00, 0x00, 0x00, 0x01, 0x4B, 0x00, 0x01,  // .....K..
                                            /* 0A68 */  0x4B, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFA, 0x00,  // K.......
                                            /* 0A70 */  0x00, 0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x01,  // ........
                                            /* 0A78 */  0x00, 0x00, 0x01, 0x00, 0x00, 0x01, 0x00, 0x80,  // ........
                                            /* 0A80 */  0x00, 0x20, 0x00, 0x00, 0x00, 0x03, 0x47, 0x0C,  // . ....G.
                                            /* 0A88 */  0xCC, 0xCD, 0x00, 0x33, 0x33, 0x00, 0x2E, 0x14,  // ...33...
                                            /* 0A90 */  0x00, 0x2E, 0x14, 0x01, 0x40, 0x00, 0x00, 0x00,  // ....@...
                                            /* 0A98 */  0x01, 0x01, 0x80, 0x00, 0x03, 0x00, 0x00, 0x00,  // ........
                                            /* 0AA0 */  0x01, 0x00, 0x07, 0xC2, 0x8F, 0x00, 0x10, 0x00,  // ........
                                            /* 0AA8 */  0x08, 0x00, 0x00, 0x00, 0x19, 0x9A, 0x00, 0x00,  // ........
                                            /* 0AB0 */  0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x01, 0x01,  // ........
                                            /* 0AB8 */  0x47, 0xAE, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00,  // G...@...
                                            /* 0AC0 */  0x60, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00,  // `.......
                                            /* 0AC8 */  0x02, 0x00, 0x00, 0x30, 0x00, 0x00, 0x02, 0x00,  // ...0....
                                            /* 0AD0 */  0x00, 0x18, 0xEC, 0x00, 0x00, 0x00, 0x03, 0xD7,  // ........
                                            /* 0AD8 */  0x01, 0x00, 0x00, 0x20, 0x00, 0x00, 0x01, 0x00,  // ... ....
                                            /* 0AE0 */  0x00, 0x41, 0x33, 0x5F, 0x52, 0x69, 0x67, 0x68,  // .A3_Righ
                                            /* 0AE8 */  0x74, 0x5F, 0x30, 0x37, 0x31, 0x33, 0x56, 0x31,  // t_0713V1
                                            /* 0AF0 */  0x38, 0x2E, 0x63, 0x6F, 0x6E, 0x66, 0x69, 0x67,  // 8.config
                                            /* 0AF8 */  0x00, 0xF1, 0x0C, 0x00, 0x03, 0xF0, 0x01, 0x00,  // ........
                                            /* 0B00 */  0x00, 0x53, 0x50, 0x31, 0x5F, 0x30, 0x30, 0xF0,  // .SP1_00.
                                            /* 0B08 */  0x01, 0xBC, 0xFF, 0x5C, 0xD5, 0x00, 0x00, 0x00,  // ...\....
                                            ...
                                            /* 0B48 */  0x00, 0x00, 0x00, 0x00, 0x84, 0x00, 0x00, 0x02,  // ........
                                            /* 0B50 */  0xFF, 0xFF, 0xA5, 0x00, 0x01, 0xBA, 0xFF, 0xFF,  // ........
                                            /* 0B58 */  0x71, 0x00, 0x00, 0xC2, 0x00, 0x00, 0x0F, 0xFF,  // q.......
                                            /* 0B60 */  0xFF, 0x8D, 0x00, 0x00, 0x27, 0xFF, 0xFE, 0xDB,  // ....'...
                                            /* 0B68 */  0x00, 0x00, 0x63, 0xFF, 0xFE, 0xD9, 0xFF, 0xFF,  // ..c.....
                                            /* 0B70 */  0x67, 0xFF, 0xFF, 0x48, 0xFF, 0xFF, 0x7F, 0x00,  // g..H....
                                            /* 0B78 */  0x01, 0x29, 0x00, 0x00, 0xB3, 0xFF, 0xFD, 0xD9,  // .)......
                                            /* 0B80 */  0x00, 0x01, 0x1F, 0xFF, 0xFE, 0xE9, 0x00, 0x00,  // ........
                                            /* 0B88 */  0x44, 0x00, 0x00, 0x1C, 0xFF, 0xFE, 0xE0, 0xFF,  // D.......
                                            /* 0B90 */  0xFD, 0xC6, 0xFF, 0xFF, 0xB6, 0xFF, 0xFE, 0x93,  // ........
                                            /* 0B98 */  0x00, 0x00, 0x37, 0xFF, 0xFF, 0x78, 0xFF, 0xFF,  // ..7..x..
                                            /* 0BA0 */  0x80, 0xFF, 0xFE, 0xB6, 0x00, 0x00, 0x06, 0xFF,  // ........
                                            /* 0BA8 */  0xFE, 0x83, 0xFF, 0xFF, 0x93, 0xFF, 0xFE, 0x1F,  // ........
                                            /* 0BB0 */  0xFF, 0xFF, 0x50, 0xFF, 0xFE, 0x11, 0xFF, 0xFF,  // ..P.....
                                            /* 0BB8 */  0x43, 0xFF, 0xFE, 0x92, 0xFF, 0xFE, 0x40, 0xFF,  // C.....@.
                                            /* 0BC0 */  0xFD, 0xF8, 0xFF, 0xFE, 0x3A, 0xFF, 0xFE, 0x18,  // ....:...
                                            /* 0BC8 */  0xFF, 0xFE, 0x1F, 0xFF, 0xFE, 0x0C, 0xFF, 0xFE,  // ........
                                            /* 0BD0 */  0x20, 0xFF, 0xFE, 0xD2, 0xFF, 0xFE, 0x26, 0xFF,  //  .....&.
                                            /* 0BD8 */  0xFF, 0x08, 0xFF, 0xFD, 0xE4, 0xFF, 0xFC, 0xC8,  // ........
                                            /* 0BE0 */  0xFF, 0xFE, 0xA8, 0xFF, 0xFD, 0xBE, 0xFF, 0xFC,  // ........
                                            /* 0BE8 */  0xE9, 0xFF, 0xFC, 0x6C, 0xFF, 0xFE, 0xB5, 0xFF,  // ...l....
                                            /* 0BF0 */  0xFF, 0x5A, 0xFF, 0xFC, 0xCA, 0xFF, 0xFE, 0x30,  // .Z.....0
                                            /* 0BF8 */  0xFF, 0xFC, 0xA6, 0xFF, 0xFD, 0x29, 0xFF, 0xFC,  // .....)..
                                            /* 0C00 */  0xE6, 0xFF, 0xFD, 0xF5, 0xFF, 0xFB, 0xE4, 0xFF,  // ........
                                            /* 0C08 */  0xFC, 0x3F, 0xFF, 0xFB, 0xBF, 0xFF, 0xFD, 0x22,  // .?....."
                                            /* 0C10 */  0xFF, 0xFD, 0xE8, 0xFF, 0xFD, 0x21, 0xFF, 0xFD,  // .....!..
                                            /* 0C18 */  0x36, 0xFF, 0xFB, 0x27, 0xFF, 0xFD, 0x10, 0xFF,  // 6..'....
                                            /* 0C20 */  0xFB, 0x93, 0xFF, 0xFF, 0x2E, 0xFF, 0xFB, 0xAD,  // ........
                                            /* 0C28 */  0xFF, 0xFC, 0x6C, 0xFF, 0xFD, 0x2A, 0xFF, 0xFC,  // ..l..*..
                                            /* 0C30 */  0xD7, 0xFF, 0xFC, 0x71, 0xFF, 0xFD, 0x2D, 0xFF,  // ...q..-.
                                            /* 0C38 */  0xFC, 0x07, 0xFF, 0xFC, 0x83, 0xFF, 0xFE, 0x3E,  // .......>
                                            /* 0C40 */  0xFF, 0xFB, 0x0D, 0xFF, 0xFE, 0x8F, 0xFF, 0xFC,  // ........
                                            /* 0C48 */  0x4E, 0xFF, 0xFE, 0x45, 0xFF, 0xFA, 0x3C, 0xFF,  // N..E..<.
                                            /* 0C50 */  0xFC, 0xFF, 0xFF, 0xF7, 0x9B, 0xFF, 0xFD, 0xA6,  // ........
                                            /* 0C58 */  0xFF, 0xFC, 0x27, 0x00, 0x03, 0x63, 0xFF, 0xFE,  // ..'..c..
                                            /* 0C60 */  0xCD, 0x00, 0x05, 0x1F, 0xFF, 0xF8, 0x15, 0xFF,  // ........
                                            /* 0C68 */  0xFE, 0x89, 0xFF, 0xEB, 0x72, 0xFF, 0xF5, 0x68,  // ....r..h
                                            /* 0C70 */  0xFF, 0xE9, 0x84, 0x00, 0x05, 0x38, 0xFF, 0xFE,  // .....8..
                                            /* 0C78 */  0xB9, 0x00, 0x26, 0x22, 0x00, 0x0E, 0x5D, 0x00,  // ..&"..].
                                            /* 0C80 */  0x21, 0x79, 0xFF, 0xDD, 0xD8, 0xFF, 0xE6, 0x8F,  // !y......
                                            /* 0C88 */  0xFF, 0x93, 0xD2, 0xFF, 0xD4, 0xA9, 0xFF, 0xBA,  // ........
                                            /* 0C90 */  0xEB, 0x00, 0x5C, 0x3A, 0x00, 0x57, 0x88, 0x00,  // ..\:.W..
                                            /* 0C98 */  0xF3, 0x4B, 0x00, 0x4F, 0xAD, 0x00, 0x5B, 0xE1,  // .K.O..[.
                                            /* 0CA0 */  0xFE, 0xB9, 0x8A, 0x09, 0x66, 0xEA, 0x00, 0x9B,  // ....f...
                                            /* 0CA8 */  0x9A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                                            ...
                                            /* 0CC8 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x53, 0x33, 0x33,  // .....S33
                                            /* 0CD0 */  0x6C, 0xCC, 0xCD, 0x20, 0x00, 0x00, 0x20, 0x00,  // l.. .. .
                                            /* 0CD8 */  0x00, 0x20, 0x00, 0x00, 0x18, 0xA3, 0xD7, 0x00,  // . ......
                                            /* 0CE0 */  0x03, 0x65, 0x00, 0x03, 0x66, 0x04, 0x00, 0x00,  // .e..f...
                                            /* 0CE8 */  0x00, 0x4C, 0xCD, 0x19, 0x00, 0x00, 0x00, 0x67,  // .L.....g
                                            /* 0CF0 */  0x38, 0x41, 0x33, 0x5F, 0x52, 0x69, 0x67, 0x68,  // 8A3_Righ
                                            /* 0CF8 */  0x74, 0x5F, 0x30, 0x37, 0x31, 0x33, 0x56, 0x30,  // t_0713V0
                                            /* 0D00 */  0x31, 0x2E, 0x73, 0x70, 0x65, 0x61, 0x6B, 0x65,  // 1.speake
                                            /* 0D08 */  0x72, 0x00, 0x72, 0x69, 0x67, 0x68, 0x74, 0x00,  // r.right.
                                            /* 0D10 */  0xE1, 0x0D, 0x00, 0x03, 0xC9, 0x00, 0x00, 0x00,  // ........
                                            /* 0D18 */  0x43, 0x4F, 0x31, 0x5F, 0x30, 0x31, 0xC9, 0x00,  // CO1_01..
                                            /* 0D20 */  0x5C, 0xBA, 0x3D, 0xDA, 0x4E, 0x58, 0x50, 0x00,  // \.=.NXP.
                                            /* 0D28 */  0x00, 0x00, 0x00, 0x00, 0x64, 0x65, 0x76, 0x6B,  // ....devk
                                            /* 0D30 */  0x69, 0x74, 0x00, 0x00, 0x76, 0x65, 0x72, 0x20,  // it..ver 
                                            /* 0D38 */  0x31, 0x2E, 0x30, 0x00, 0x0F, 0xCC, 0xCD, 0x01,  // 1.0.....
                                            /* 0D40 */  0xF6, 0x66, 0x00, 0x7B, 0x33, 0x00, 0x00, 0x64,  // .f.{3..d
                                            /* 0D48 */  0x00, 0x00, 0x02, 0x1A, 0xFD, 0x2F, 0x1B, 0x58,  // ...../.X
                                            /* 0D50 */  0x10, 0x1C, 0x72, 0x05, 0x00, 0x49, 0x9A, 0x00,  // ..r..I..
                                            /* 0D58 */  0x00, 0x01, 0x00, 0x00, 0x02, 0x00, 0x00, 0x01,  // ........
                                            /* 0D60 */  0x00, 0x00, 0x00, 0x00, 0x01, 0x4B, 0x00, 0x01,  // .....K..
                                            /* 0D68 */  0x4B, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFA, 0x00,  // K.......
                                            /* 0D70 */  0x00, 0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x01,  // ........
                                            /* 0D78 */  0x00, 0x00, 0x01, 0x00, 0x00, 0x01, 0x00, 0x80,  // ........
                                            /* 0D80 */  0x00, 0x20, 0x00, 0x00, 0x00, 0x03, 0x47, 0x0C,  // . ....G.
                                            /* 0D88 */  0xCC, 0xCD, 0x00, 0x33, 0x33, 0x00, 0x2E, 0x14,  // ...33...
                                            /* 0D90 */  0x00, 0x2E, 0x14, 0x01, 0x40, 0x00, 0x00, 0x00,  // ....@...
                                            /* 0D98 */  0x01, 0x01, 0x80, 0x00, 0x03, 0x00, 0x00, 0x00,  // ........
                                            /* 0DA0 */  0x01, 0x00, 0x07, 0xC2, 0x8F, 0x00, 0x10, 0x00,  // ........
                                            /* 0DA8 */  0x08, 0x00, 0x00, 0x00, 0x19, 0x9A, 0x00, 0x00,  // ........
                                            /* 0DB0 */  0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x01, 0x01,  // ........
                                            /* 0DB8 */  0x47, 0xAE, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00,  // G...@...
                                            /* 0DC0 */  0x60, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00,  // `.......
                                            /* 0DC8 */  0x02, 0x00, 0x00, 0x30, 0x00, 0x00, 0x02, 0x00,  // ...0....
                                            /* 0DD0 */  0x00, 0x18, 0xEC, 0x00, 0x00, 0x00, 0x03, 0xD7,  // ........
                                            /* 0DD8 */  0x01, 0x00, 0x00, 0x20, 0x00, 0x00, 0x01, 0x00,  // ... ....
                                            /* 0DE0 */  0x00, 0x41, 0x33, 0x5F, 0x4C, 0x65, 0x66, 0x74,  // .A3_Left
                                            /* 0DE8 */  0x5F, 0x30, 0x37, 0x31, 0x33, 0x56, 0x31, 0x38,  // _0713V18
                                            /* 0DF0 */  0x2E, 0x63, 0x6F, 0x6E, 0x66, 0x69, 0x67, 0x00,  // .config.
                                            /* 0DF8 */  0xF0, 0x0F, 0x00, 0x03, 0xF0, 0x01, 0x00, 0x00,  // ........
                                            /* 0E00 */  0x53, 0x50, 0x31, 0x5F, 0x30, 0x30, 0xF0, 0x01,  // SP1_00..
                                            /* 0E08 */  0x71, 0x1E, 0x0D, 0xC9, 0x00, 0x00, 0x00, 0x00,  // q.......
                                            ...
                                            /* 0E48 */  0x00, 0xFF, 0xFF, 0xE9, 0x00, 0x00, 0x8A, 0xFF,  // ........
                                            /* 0E50 */  0xFD, 0x79, 0x00, 0x00, 0xD8, 0x00, 0x01, 0x17,  // .y......
                                            /* 0E58 */  0x00, 0x02, 0x72, 0x00, 0x00, 0x65, 0x00, 0x00,  // ..r..e..
                                            /* 0E60 */  0x68, 0xFF, 0xFF, 0x27, 0xFF, 0xFD, 0xDC, 0x00,  // h..'....
                                            /* 0E68 */  0x02, 0x0E, 0xFF, 0xFD, 0x6F, 0x00, 0x02, 0x2D,  // ....o..-
                                            /* 0E70 */  0xFF, 0xFE, 0x66, 0x00, 0x01, 0xDE, 0xFF, 0xFF,  // ..f.....
                                            /* 0E78 */  0xC5, 0x00, 0x03, 0x67, 0x00, 0x02, 0xDD, 0x00,  // ...g....
                                            /* 0E80 */  0x01, 0xAD, 0x00, 0x02, 0xDE, 0xFF, 0xFC, 0x0E,  // ........
                                            /* 0E88 */  0x00, 0x01, 0x9C, 0xFF, 0xFD, 0x40, 0x00, 0x00,  // .....@..
                                            /* 0E90 */  0x31, 0x00, 0x00, 0xE3, 0x00, 0x02, 0x9C, 0x00,  // 1.......
                                            /* 0E98 */  0x01, 0x0D, 0x00, 0x04, 0x70, 0xFF, 0xFE, 0xA3,  // ....p...
                                            /* 0EA0 */  0xFF, 0xFE, 0x2E, 0xFF, 0xFC, 0xA0, 0xFF, 0xFD,  // ........
                                            /* 0EA8 */  0xC2, 0x00, 0x03, 0x0C, 0x00, 0x00, 0xB4, 0x00,  // ........
                                            /* 0EB0 */  0x03, 0xBD, 0x00, 0x00, 0x85, 0xFF, 0xFC, 0x8C,  // ........
                                            /* 0EB8 */  0x00, 0x00, 0x09, 0xFF, 0xFA, 0x20, 0x00, 0x00,  // ..... ..
                                            /* 0EC0 */  0x68, 0xFF, 0xFE, 0x06, 0x00, 0x05, 0xD8, 0xFF,  // h.......
                                            /* 0EC8 */  0xFE, 0x1D, 0x00, 0x03, 0x84, 0xFF, 0xFA, 0x0D,  // ........
                                            /* 0ED0 */  0x00, 0x01, 0xA6, 0xFF, 0xFA, 0xD7, 0x00, 0x02,  // ........
                                            /* 0ED8 */  0x7E, 0xFF, 0xFB, 0xE7, 0x00, 0x01, 0x4E, 0xFF,  // ~.....N.
                                            /* 0EE0 */  0xFC, 0x3E, 0xFF, 0xFE, 0xE6, 0xFF, 0xFB, 0x55,  // .>.....U
                                            /* 0EE8 */  0x00, 0x00, 0x06, 0xFF, 0xFE, 0x5C, 0xFF, 0xFC,  // .....\..
                                            /* 0EF0 */  0x51, 0xFF, 0xFC, 0xEC, 0xFF, 0xFE, 0x0B, 0xFF,  // Q.......
                                            /* 0EF8 */  0xFF, 0xC8, 0xFF, 0xFF, 0x03, 0xFF, 0xFC, 0xD3,  // ........
                                            /* 0F00 */  0xFF, 0xFB, 0xD1, 0xFF, 0xFA, 0xC1, 0xFF, 0xF9,  // ........
                                            /* 0F08 */  0x11, 0x00, 0x03, 0x52, 0xFF, 0xFD, 0x2F, 0x00,  // ...R../.
                                            /* 0F10 */  0x00, 0x08, 0xFF, 0xFA, 0xD6, 0xFF, 0xFA, 0xFF,  // ........
                                            /* 0F18 */  0xFF, 0xF9, 0x3B, 0xFF, 0xFD, 0xF3, 0xFF, 0xF9,  // ..;.....
                                            /* 0F20 */  0xA9, 0xFF, 0xFE, 0xE7, 0xFF, 0xFC, 0x7D, 0xFF,  // ......}.
                                            /* 0F28 */  0xFD, 0xC6, 0xFF, 0xFE, 0x64, 0xFF, 0xFC, 0x2B,  // ....d..+
                                            /* 0F30 */  0xFF, 0xFA, 0x70, 0xFF, 0xFB, 0x47, 0xFF, 0xFA,  // ..p..G..
                                            /* 0F38 */  0xAB, 0xFF, 0xF9, 0x5B, 0xFF, 0xFB, 0xF4, 0xFF,  // ...[....
                                            /* 0F40 */  0xF8, 0xCF, 0xFF, 0xFD, 0xC1, 0xFF, 0xFD, 0xAA,  // ........
                                            /* 0F48 */  0xFF, 0xFC, 0x83, 0xFF, 0xFB, 0x45, 0xFF, 0xFA,  // .....E..
                                            /* 0F50 */  0xD7, 0xFF, 0xF6, 0x91, 0xFF, 0xFC, 0x1A, 0xFF,  // ........
                                            /* 0F58 */  0xF3, 0x99, 0x00, 0x01, 0x49, 0xFF, 0xF9, 0xC8,  // ....I...
                                            /* 0F60 */  0x00, 0x06, 0x5B, 0xFF, 0xFB, 0x84, 0xFF, 0xFD,  // ..[.....
                                            /* 0F68 */  0x8E, 0xFF, 0xEC, 0x07, 0xFF, 0xF8, 0x61, 0xFF,  // ......a.
                                            /* 0F70 */  0xEA, 0x82, 0x00, 0x03, 0xF0, 0xFF, 0xF4, 0x61,  // .......a
                                            /* 0F78 */  0x00, 0x1F, 0x69, 0xFF, 0xFD, 0xC4, 0x00, 0x24,  // ..i....$
                                            /* 0F80 */  0x0B, 0xFF, 0xDF, 0x1B, 0xFF, 0xF3, 0x4F, 0xFF,  // ......O.
                                            /* 0F88 */  0x9D, 0xBD, 0xFF, 0xDE, 0x6E, 0xFF, 0xB9, 0x52,  // ....n..R
                                            /* 0F90 */  0x00, 0x52, 0x2D, 0x00, 0x45, 0xB7, 0x00, 0xDD,  // .R-.E...
                                            /* 0F98 */  0x2E, 0x00, 0x47, 0x2F, 0x00, 0x62, 0x81, 0xFE,  // ..G/.b..
                                            /* 0FA0 */  0xC3, 0x37, 0x09, 0x76, 0x70, 0x00, 0x6D, 0x07,  // .7.vp.m.
                                            ...
                                            /* 0FC8 */  0x00, 0x00, 0x00, 0x00, 0x4A, 0x3D, 0x71, 0x6C,  // ....J=ql
                                            /* 0FD0 */  0xCC, 0xCD, 0x20, 0x00, 0x00, 0x20, 0x00, 0x00,  // .. .. ..
                                            /* 0FD8 */  0x20, 0x00, 0x00, 0x17, 0x0A, 0x3D, 0x00, 0x03,  //  ....=..
                                            /* 0FE0 */  0x65, 0x00, 0x03, 0x66, 0x04, 0x66, 0x66, 0x00,  // e..f.ff.
                                            /* 0FE8 */  0x4C, 0xCD, 0x19, 0x00, 0x00, 0x00, 0x67, 0x38,  // L.....g8
                                            /* 0FF0 */  0x41, 0x33, 0x5F, 0x4C, 0x65, 0x66, 0x74, 0x5F,  // A3_Left_
                                            /* 0FF8 */  0x30, 0x37, 0x31, 0x33, 0x56, 0x30, 0x31, 0x2E,  // 0713V01.
                                            /* 1000 */  0x73, 0x70, 0x65, 0x61, 0x6B, 0x65, 0x72, 0x00,  // speaker.
                                            /* 1008 */  0x6D, 0x75, 0x73, 0x69, 0x63, 0x4C, 0x00, 0xD8,  // musicL..
                                            /* 1010 */  0x11, 0x00, 0x03, 0xC1, 0x01, 0x00, 0x00, 0x56,  // .......V
                                            /* 1018 */  0x50, 0x32, 0x5F, 0x30, 0x31, 0x00, 0x00, 0x16,  // P2_01...
                                            /* 1020 */  0x72, 0x37, 0x9F, 0x4E, 0x58, 0x50, 0x00, 0x00,  // r7.NXP..
                                            /* 1028 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                                            /* 1030 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                                            /* 1038 */  0x00, 0x00, 0x00, 0x01, 0x08, 0x00, 0x00, 0x00,  // ........
                                            /* 1040 */  0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x64, 0x00,  // ......d.
                                            /* 1048 */  0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x17, 0x70,  // .......p
                                            /* 1050 */  0x00, 0x00, 0x00, 0x00, 0x01, 0x2C, 0x01, 0x47,  // .....,.G
                                            /* 1058 */  0xAE, 0x00, 0x2B, 0xB0, 0x00, 0x00, 0xD2, 0x00,  // ..+.....
                                            /* 1060 */  0x37, 0xB5, 0x00, 0x40, 0x00, 0xFF, 0x80, 0x00,  // 7..@....
                                            /* 1068 */  0x03, 0x00, 0x00, 0x0A, 0xCC, 0xCD, 0x0A, 0x66,  // .......f
                                            /* 1070 */  0x66, 0x02, 0x80, 0x00, 0x01, 0x00, 0x00, 0x00,  // f.......
                                            /* 1078 */  0x0C, 0xCD, 0x00, 0x0C, 0xCD, 0x00, 0x0A, 0x3D,  // .......=
                                            /* 1080 */  0x00, 0x01, 0x48, 0x00, 0x80, 0x00, 0x00, 0x02,  // ..H.....
                                            /* 1088 */  0x8F, 0x00, 0x02, 0x8F, 0x08, 0x00, 0x00, 0x07,  // ........
                                            /* 1090 */  0xD7, 0x0A, 0x00, 0x0C, 0xCD, 0x00, 0x00, 0x14,  // ........
                                            /* 1098 */  0x00, 0x00, 0x01, 0xC1, 0x66, 0x80, 0x7E, 0x95,  // ....f.~.
                                            /* 10A0 */  0x81, 0x0F, 0xE6, 0x32, 0xE0, 0x33, 0x9B, 0x0F,  // ...2.3..
                                            /* 10A8 */  0xE6, 0x32, 0x01, 0x03, 0x00, 0x00, 0xF0, 0x42,  // .2.....B
                                            /* 10B0 */  0x8F, 0xC2, 0x35, 0x3F, 0x00, 0x00, 0x40, 0xC1,  // ..5?..@.
                                            /* 10B8 */  0x00, 0x00, 0x01, 0xC2, 0x17, 0xAE, 0x7D, 0xDF,  // ......}.
                                            /* 10C0 */  0x6A, 0x3E, 0x6C, 0x41, 0x82, 0x1D, 0x40, 0x3F,  // j>lA..@?
                                            /* 10C8 */  0x78, 0xBB, 0x00, 0x04, 0x00, 0x00, 0xB4, 0x42,  // x......B
                                            /* 10D0 */  0x33, 0x33, 0xB3, 0x3F, 0x69, 0x00, 0x40, 0xC1,  // 33.?i.@.
                                            /* 10D8 */  0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                                            /* 10E0 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40,  // .......@
                                            /* 10E8 */  0x00, 0x00, 0x00, 0x01, 0x00, 0x80, 0x3B, 0x46,  // ......;F
                                            /* 10F0 */  0xF4, 0xFD, 0x34, 0x3F, 0x00, 0x00, 0x00, 0x00,  // ..4?....
                                            /* 10F8 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                                            /* 1100 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x39,  // .......9
                                            /* 1108 */  0x2C, 0xED, 0x00, 0x01, 0x00, 0xE0, 0xF6, 0x45,  // ,......E
                                            /* 1110 */  0x00, 0x00, 0x80, 0x40, 0x00, 0x00, 0xE0, 0xC0,  // ...@....
                                            /* 1118 */  0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                                            /* 1120 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x71,  // .......q
                                            /* 1128 */  0xCF, 0x54, 0x00, 0x01, 0x00, 0x00, 0x16, 0x44,  // .T.....D
                                            /* 1130 */  0xF3, 0x04, 0xB5, 0x3F, 0x00, 0x00, 0xA0, 0x40,  // ...?...@
                                            /* 1138 */  0x00, 0x00, 0x01, 0xD5, 0xF6, 0x71, 0x4C, 0x88,  // .....qL.
                                            /* 1140 */  0x96, 0x2D, 0xAD, 0xEB, 0xB3, 0x77, 0x6A, 0x3C,  // .-...wj<
                                            /* 1148 */  0x5B, 0xA4, 0x00, 0x07, 0x00, 0x80, 0xB6, 0x45,  // [......E
                                            /* 1150 */  0x00, 0x00, 0x20, 0x40, 0x00, 0x00, 0x60, 0xC0,  // .. @..`.
                                            /* 1158 */  0x00, 0x00, 0x01, 0xCB, 0x65, 0x61, 0x6E, 0x6A,  // ....eanj
                                            /* 1160 */  0x74, 0x35, 0x9D, 0xEA, 0x91, 0x95, 0x8C, 0x3E,  // t5.....>
                                            /* 1168 */  0xFC, 0xB5, 0x00, 0x07, 0x00, 0x40, 0x1C, 0x45,  // .....@.E
                                            /* 1170 */  0x00, 0x00, 0x00, 0x40, 0x9A, 0x99, 0xD9, 0xBF,  // ...@....
                                            /* 1178 */  0x00, 0x00, 0x01, 0xC8, 0xC6, 0xD9, 0x75, 0xA7,  // ......u.
                                            /* 1180 */  0xF9, 0x38, 0xC7, 0x3B, 0x8A, 0x58, 0x07, 0x3E,  // .8.;.X.>
                                            /* 1188 */  0x71, 0xEB, 0x00, 0x07, 0x00, 0x00, 0x9B, 0x44,  // q......D
                                            /* 1190 */  0x9A, 0x99, 0xD9, 0x3F, 0x33, 0x33, 0x73, 0xC0,  // ...?33s.
                                            /* 1198 */  0x00, 0x00, 0x01, 0xF4, 0xBB, 0x11, 0xF1, 0x50,  // .......P
                                            /* 11A0 */  0xD2, 0x0B, 0x44, 0xEF, 0x0E, 0xAF, 0x2E, 0x40,  // ..D....@
                                            /* 11A8 */  0x00, 0x00, 0x00, 0x07, 0x00, 0xF0, 0x52, 0x46,  // ......RF
                                            /* 11B0 */  0x33, 0x33, 0x33, 0x3F, 0x00, 0x00, 0x00, 0x00,  // 333?....
                                            /* 11B8 */  0x00, 0x00, 0x02, 0xFA, 0x21, 0x06, 0xF6, 0x32,  // ....!..2
                                            /* 11C0 */  0xC2, 0x2F, 0x72, 0x79, 0x5E, 0xE4, 0xF2, 0x2F,  // ./ry^../
                                            /* 11C8 */  0x72, 0x79, 0x01, 0x02, 0x00, 0xC0, 0x5A, 0x46,  // ry....ZF
                                            /* 11D0 */  0x33, 0x33, 0x33, 0x3F, 0x00, 0x00, 0x40, 0x41,  // 333?..@A
                                            /* 11D8 */  0x41, 0x33, 0x5F, 0x52, 0x69, 0x67, 0x68, 0x74,  // A3_Right
                                            /* 11E0 */  0x5F, 0x30, 0x37, 0x32, 0x32, 0x46, 0x30, 0x31,  // _0722F01
                                            /* 11E8 */  0x2E, 0x76, 0x73, 0x74, 0x65, 0x70, 0x00, 0x73,  // .vstep.s
                                            /* 11F0 */  0x70, 0x65, 0x65, 0x63, 0x68, 0x4C, 0x00, 0x62,  // peechL.b
                                            /* 11F8 */  0x79, 0x70, 0x61, 0x73, 0x73, 0x4C, 0x00, 0x6D,  // ypassL.m
                                            /* 1200 */  0x75, 0x73, 0x69, 0x63, 0x52, 0x00, 0xCF, 0x13,  // usicR...
                                            /* 1208 */  0x00, 0x03, 0xC1, 0x01, 0x00, 0x00, 0x56, 0x50,  // ......VP
                                            /* 1210 */  0x32, 0x5F, 0x30, 0x31, 0x00, 0x00, 0x16, 0x72,  // 2_01...r
                                            /* 1218 */  0x37, 0x9F, 0x4E, 0x58, 0x50, 0x00, 0x00, 0x00,  // 7.NXP...
                                            /* 1220 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                                            /* 1228 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                                            /* 1230 */  0x00, 0x00, 0x01, 0x08, 0x00, 0x00, 0x00, 0x00,  // ........
                                            /* 1238 */  0x00, 0x00, 0x01, 0x00, 0x00, 0x64, 0x00, 0x00,  // .....d..
                                            /* 1240 */  0x02, 0x00, 0x00, 0x00, 0x00, 0x17, 0x70, 0x00,  // ......p.
                                            /* 1248 */  0x00, 0x00, 0x00, 0x01, 0x2C, 0x01, 0x47, 0xAE,  // ....,.G.
                                            /* 1250 */  0x00, 0x2B, 0xB0, 0x00, 0x00, 0xD2, 0x00, 0x37,  // .+.....7
                                            /* 1258 */  0xB5, 0x00, 0x40, 0x00, 0xFF, 0x80, 0x00, 0x03,  // ..@.....
                                            /* 1260 */  0x00, 0x00, 0x0A, 0xCC, 0xCD, 0x0A, 0x66, 0x66,  // ......ff
                                            /* 1268 */  0x02, 0x80, 0x00, 0x01, 0x00, 0x00, 0x00, 0x0C,  // ........
                                            /* 1270 */  0xCD, 0x00, 0x0C, 0xCD, 0x00, 0x0A, 0x3D, 0x00,  // ......=.
                                            /* 1278 */  0x01, 0x48, 0x00, 0x80, 0x00, 0x00, 0x02, 0x8F,  // .H......
                                            /* 1280 */  0x00, 0x02, 0x8F, 0x08, 0x00, 0x00, 0x07, 0xD7,  // ........
                                            /* 1288 */  0x0A, 0x00, 0x0C, 0xCD, 0x00, 0x00, 0x14, 0x00,  // ........
                                            /* 1290 */  0x00, 0x01, 0xC1, 0x66, 0x80, 0x7E, 0x95, 0x81,  // ...f.~..
                                            /* 1298 */  0x0F, 0xE6, 0x32, 0xE0, 0x33, 0x9B, 0x0F, 0xE6,  // ..2.3...
                                            /* 12A0 */  0x32, 0x01, 0x03, 0x00, 0x00, 0xF0, 0x42, 0x8F,  // 2.....B.
                                            /* 12A8 */  0xC2, 0x35, 0x3F, 0x00, 0x00, 0x40, 0xC1, 0x00,  // .5?..@..
                                            /* 12B0 */  0x00, 0x01, 0xC2, 0x17, 0xAE, 0x7D, 0xDF, 0x6A,  // .....}.j
                                            /* 12B8 */  0x3E, 0x6C, 0x41, 0x82, 0x1D, 0x40, 0x3F, 0x78,  // >lA..@?x
                                            /* 12C0 */  0xBB, 0x00, 0x04, 0x00, 0x00, 0xB4, 0x42, 0x33,  // ......B3
                                            /* 12C8 */  0x33, 0xB3, 0x3F, 0x69, 0x00, 0x40, 0xC1, 0x00,  // 3.?i.@..
                                            /* 12D0 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                                            /* 12D8 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x00,  // ......@.
                                            /* 12E0 */  0x00, 0x00, 0x01, 0x00, 0x80, 0x3B, 0x46, 0xF4,  // .....;F.
                                            /* 12E8 */  0xFD, 0x34, 0x3F, 0x00, 0x00, 0x00, 0x00, 0x00,  // .4?.....
                                            /* 12F0 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                                            /* 12F8 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x39, 0x2C,  // ......9,
                                            /* 1300 */  0xED, 0x00, 0x01, 0x00, 0xE0, 0xF6, 0x45, 0x00,  // ......E.
                                            /* 1308 */  0x00, 0x80, 0x40, 0x00, 0x00, 0xE0, 0xC0, 0x00,  // ..@.....
                                            /* 1310 */  0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                                            /* 1318 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x71, 0xCF,  // ......q.
                                            /* 1320 */  0x54, 0x00, 0x01, 0x00, 0x00, 0x16, 0x44, 0xF3,  // T.....D.
                                            /* 1328 */  0x04, 0xB5, 0x3F, 0x00, 0x00, 0xA0, 0x40, 0x00,  // ..?...@.
                                            /* 1330 */  0x00, 0x01, 0xD5, 0xF6, 0x71, 0x4C, 0x88, 0x96,  // ....qL..
                                            /* 1338 */  0x2D, 0xAD, 0xEB, 0xB3, 0x77, 0x6A, 0x3C, 0x5B,  // -...wj<[
                                            /* 1340 */  0xA4, 0x00, 0x07, 0x00, 0x80, 0xB6, 0x45, 0x00,  // ......E.
                                            /* 1348 */  0x00, 0x20, 0x40, 0x00, 0x00, 0x60, 0xC0, 0x00,  // . @..`..
                                            /* 1350 */  0x00, 0x01, 0xCB, 0x65, 0x61, 0x6E, 0x6A, 0x74,  // ...eanjt
                                            /* 1358 */  0x35, 0x9D, 0xEA, 0x91, 0x95, 0x8C, 0x3E, 0xFC,  // 5.....>.
                                            /* 1360 */  0xB5, 0x00, 0x07, 0x00, 0x40, 0x1C, 0x45, 0x00,  // ....@.E.
                                            /* 1368 */  0x00, 0x00, 0x40, 0x9A, 0x99, 0xD9, 0xBF, 0x00,  // ..@.....
                                            /* 1370 */  0x00, 0x01, 0xC8, 0xC6, 0xD9, 0x75, 0xA7, 0xF9,  // .....u..
                                            /* 1378 */  0x38, 0xC7, 0x3B, 0x8A, 0x58, 0x07, 0x3E, 0x71,  // 8.;.X.>q
                                            /* 1380 */  0xEB, 0x00, 0x07, 0x00, 0x00, 0x9B, 0x44, 0x9A,  // ......D.
                                            /* 1388 */  0x99, 0xD9, 0x3F, 0x33, 0x33, 0x73, 0xC0, 0x00,  // ..?33s..
                                            /* 1390 */  0x00, 0x01, 0xF4, 0xBB, 0x11, 0xF1, 0x50, 0xD2,  // ......P.
                                            /* 1398 */  0x0B, 0x44, 0xEF, 0x0E, 0xAF, 0x2E, 0x40, 0x00,  // .D....@.
                                            /* 13A0 */  0x00, 0x00, 0x07, 0x00, 0xF0, 0x52, 0x46, 0x33,  // .....RF3
                                            /* 13A8 */  0x33, 0x33, 0x3F, 0x00, 0x00, 0x00, 0x00, 0x00,  // 33?.....
                                            /* 13B0 */  0x00, 0x02, 0xFA, 0x21, 0x06, 0xF6, 0x32, 0xC2,  // ...!..2.
                                            /* 13B8 */  0x2F, 0x72, 0x79, 0x5E, 0xE4, 0xF2, 0x2F, 0x72,  // /ry^../r
                                            /* 13C0 */  0x79, 0x01, 0x02, 0x00, 0xC0, 0x5A, 0x46, 0x33,  // y....ZF3
                                            /* 13C8 */  0x33, 0x33, 0x3F, 0x00, 0x00, 0x40, 0x41, 0x41,  // 33?..@AA
                                            /* 13D0 */  0x33, 0x5F, 0x4C, 0x65, 0x66, 0x74, 0x5F, 0x30,  // 3_Left_0
                                            /* 13D8 */  0x37, 0x32, 0x32, 0x46, 0x30, 0x31, 0x2E, 0x76,  // 722F01.v
                                            /* 13E0 */  0x73, 0x74, 0x65, 0x70, 0x00, 0x73, 0x70, 0x65,  // step.spe
                                            /* 13E8 */  0x65, 0x63, 0x68, 0x52, 0x00, 0x62, 0x79, 0x70,  // echR.byp
                                            /* 13F0 */  0x61, 0x73, 0x73, 0x52, 0x00                     // assR.
                                        })
                                    }
                                    Default
                                    {
            ...
            {
                Name (_ADR, Zero)  // _ADR: Address
                Name (_HID, "XMCC0002")  // _HID: Hardware ID
                Name (_CID, "XMCC0002")  // _CID: Compatible ID
                Name (_SUB, "1D721502")  // _SUB: Subsystem ID
                Name (_DDN, "Charger watchdog management Device")  // _DDN: DOS Device Name
                ...
                OperationRegion (CNVS, 0x98, Zero, 0x02)
                ...
                {
                    ^^^I2C7.PMI5.SET (One, 0x5E, 0x25, 0x6A)
                    ^^^I2C7.PMI5.SET (One, 0x5E, 0x26, 0x0B)
                    ^^^I2C7.PMI5.SET (One, 0x5E, 0x24, 0x02)
                    Local0 = ^^^I2C7.PMI5.GET (One, 0x5E, 0x28)
                    Local0 >>= 0x02
                    Local0 &= 0x07
                    Local1 = (Local0 >> One)
                    ...
                    ^^^I2C7.PMI5.SET (One, 0x5E, 0x25, 0x6A)
                    ^^^I2C7.PMI5.SET (One, 0x5E, 0x26, 0x03)
                    ^^^I2C7.PMI5.SET (One, 0x5E, 0x24, 0x02)
                    Local0 = ^^^I2C7.PMI5.GET (One, 0x5E, 0x28)
                    Local0 >>= 0x04
                    Local0 &= 0x03
                ...
                {
                    ^^^I2C7.PMI5.SET (One, 0x5E, 0x25, 0x6A)
                    ^^^I2C7.PMI5.SET (One, 0x5E, 0x26, 0x07)
                    ^^^I2C7.PMI5.SET (One, 0x5E, 0x24, 0x02)
                    Local0 = ^^^I2C7.PMI5.GET (One, 0x5E, 0x28)
                    Local0 &= 0xCF
                    ^^^I2C7.PMI5.SET (One, 0x5E, 0x25, 0x6A)
                    ^^^I2C7.PMI5.SET (One, 0x5E, 0x26, 0x07)
                    ^^^I2C7.PMI5.SET (One, 0x5E, 0x27, Local0)
                    ^^^I2C7.PMI5.SET (One, 0x5E, 0x24, One)
                }

                Method (WGFD, 0, NotSerialized)
                {
                    ^^^I2C7.PMI5.SET (One, 0x5E, 0x25, 0x6A)
                    ^^^I2C7.PMI5.SET (One, 0x5E, 0x26, 0x03)
                    ^^^I2C7.PMI5.SET (One, 0x5E, 0x24, 0x02)
                ...
                Method (OTDN, 0, NotSerialized)
                {
                }

                Method (OTEN, 0, NotSerialized)
                {
                }
            }
            ...
            {
                Name (_ADR, Zero)  // _ADR: Address
                Name (_HID, "NXP9890")  // _HID: Hardware ID
                Name (_CID, "NXP9890")  // _CID: Compatible ID
                Name (_UID, One)  // _UID: Unique ID
                Method (_STA, 0, NotSerialized)  // _STA: Status
                {
                    If ((OSID == 0x04))
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.PCI0.I2C2.SPAL._CRS.SBUF */
                }
            }
            ...
            Device (SPAR)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.PCI0.I2C2.SPAR._CRS.SBUF */
                }
            }
            ...
            Device (WOL1)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.PCI0.I2C2.WOL1._CRS.SBUF */
                }

                Method (_STA, 0, NotSerialized)  // _STA: Status
                {
                    Return (Zero)
                    If (((SKRS == One) && (WLFN == One)))
                    {
                        Return (0x0F)
                    }
            ...
            {
                Name (_ADR, Zero)  // _ADR: Address
                Name (_HID, "LP855600")  // _HID: Hardware ID
                Name (_CID, "LP855600")  // _CID: Compatible ID
                Name (_DDN, "TI BackLight LP85560")  // _DDN: DOS Device Name
                Name (_UID, One)  // _UID: Unique ID
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    Name (SBUF, ResourceTemplate ()
                    ...
                    Return (SBUF) /* \_SB_.PCI0.I2C2.BL01._CRS.SBUF */
                }
            ...
            {
                Name (_ADR, Zero)  // _ADR: Address
                Name (_HID, "XMCC0001")  // _HID: Hardware ID
                Name (_CID, "XMCC0001")  // _CID: Compatible ID
                Name (_SUB, "1D721502")  // _SUB: Subsystem ID
                Name (_DDN, "TI BackLight LP85560")  // _DDN: DOS Device Name
                Name (_UID, 0x02)  // _UID: Unique ID
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.PCI0.I2C2.BL02._CRS.SBUF */
                }
                ...
                OperationRegion (BNVS, 0x99, Zero, One)
        ...
        Device (I2C3)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (RBUF, \_SB.PCI0.I2C3._Y14._BAS, B0BA)  // _BAS: Base Address
                CreateDWordField (RBUF, \_SB.PCI0.I2C3._Y14._LEN, B0LN)  // _LEN: Length
                B0BA = I30A /* \I30A */
                B0LN = I30L /* \I30L */
            ...
            {
                Name (_ADR, Zero)  // _ADR: Address
                Name (_HID, "KTD20260")  // _HID: Hardware ID
                Name (_CID, "KTD20260")  // _CID: Compatible ID
                Name (_DDN, "RGB KTD20260")  // _DDN: DOS Device Name
                Name (_UID, One)  // _UID: Unique ID
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    Name (SBUF, ResourceTemplate ()
                    ...
                    Return (SBUF) /* \_SB_.PCI0.I2C3.RGB0._CRS.SBUF */
                }
        ...
        Device (I2C4)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (RBUF, \_SB.PCI0.I2C4._Y15._BAS, B0BA)  // _BAS: Base Address
                CreateDWordField (RBUF, \_SB.PCI0.I2C4._Y15._LEN, B0LN)  // _LEN: Length
                B0BA = I40A /* \I40A */
                B0LN = I40L /* \I40L */
            ...
            {
                Name (_ADR, Zero)  // _ADR: Address
                Name (_HID, "SS5K0008")  // _HID: Hardware ID
                Name (_CID, "SS5K0008")  // _CID: Compatible ID
                Name (_SUB, "INTL0000")  // _SUB: Subsystem ID
                Name (_DDN, "S5K4H8YX")  // _DDN: DOS Device Name
                Name (_UID, One)  // _UID: Unique ID
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    If ((OSID == One))
                    {
                        Return (WBUF) /* \_SB_.PCI0.I2C4.CAM0._CRS.WBUF */
                    }
                    Else
                    {
                        Return (ABUF) /* \_SB_.PCI0.I2C4.CAM0._CRS.ABUF */
                    }
                }
            }
            ...
            {
                Name (_ADR, Zero)  // _ADR: Address
                Name (_HID, "OVTI5693")  // _HID: Hardware ID
                Name (_CID, "OVTI5693")  // _CID: Compatible ID
                Name (_SUB, "INTL0000")  // _SUB: Subsystem ID
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    If ((OSID == One))
                    {
                        Return (WBUF) /* \_SB_.PCI0.I2C4.CAM1._CRS.WBUF */
                    }
                    Else
                    {
                        Return (ABUF) /* \_SB_.PCI0.I2C4.CAM1._CRS.ABUF */
                    }
                }
            }
            ...
            {
                Name (_ADR, Zero)  // _ADR: Address
                Name (_HID, "TOSB0001")  // _HID: Hardware ID
                Name (_CID, "TOSB0001")  // _CID: Compatible ID
                Name (_SUB, "INTL0000")  // _SUB: Subsystem ID
                Name (_DDN, "T4KA3")  // _DDN: DOS Device Name
                Name (_UID, One)  // _UID: Unique ID
                Name (CDEP, Package (0x02)
                {
                    I2C7, 
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    If ((OSID == One))
                    {
                        Return (WBUF) /* \_SB_.PCI0.I2C4.CAM2._CRS.WBUF */
                    }
                    Else
                    {
                        Return (ABUF) /* \_SB_.PCI0.I2C4.CAM2._CRS.ABUF */
                    }
                }
            }
            ...
            {
                Name (_ADR, Zero)  // _ADR: Address
                Name (_HID, "XMCC0003")  // _HID: Hardware ID
                Name (_CID, "XMCC0003")  // _CID: Compatible ID
                Name (_SUB, "1D721502")  // _SUB: Subsystem ID
                Name (_DDN, "t3ka3")  // _DDN: DOS Device Name
                Name (_UID, 0x02)  // _UID: Unique ID
                Name (_DEP, Package (0x02)  // _DEP: Dependencies
                {
                    I2C7, 
                ...
                Name (_PR0, Package (0x05)  // _PR0: Power Resources for D0
                {
                    P28W, 
                    P18W, 
                    P4DW, 
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    Return (PLDB) /* \_SB_.PCI0.I2C4.CA27.PLDB */
                }
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (WBUF) /* \_SB_.PCI0.I2C4.CA27._CRS.WBUF */
                }
                ...
                Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
                {
                    ...
                    If ((Arg0 == ToUUID ("f486d39f-d657-484b-84a6-42a565712b92") /* Unknown UUID */))
                    {
                        Return (Buffer (0x20)
                        {
                            /* 0000 */  0x01, 0x00, 0x04, 0x00, 0x00, 0x00, 0x02, 0x00,  // ........
                            /* 0008 */  0x02, 0x01, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                            /* 0010 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                            /* 0018 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00   // ........
                        })
        ...
        Device (I2C5)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (RBUF, \_SB.PCI0.I2C5._Y16._BAS, B0BA)  // _BAS: Base Address
                CreateDWordField (RBUF, \_SB.PCI0.I2C5._Y16._LEN, B0LN)  // _LEN: Length
                B0BA = I50A /* \I50A */
                B0LN = I50L /* \I50L */
            ...
            {
                Name (_ADR, Zero)  // _ADR: Address
                Name (_HID, "DRV26040")  // _HID: Hardware ID
                Name (_CID, "DRV26040")  // _CID: Compatible ID
                Name (_DDN, "Motor DRV2604 Driver")  // _DDN: DOS Device Name
                Name (_UID, One)  // _UID: Unique ID
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    Name (SBUF, ResourceTemplate ()
                    ...
                    Return (SBUF) /* \_SB_.PCI0.I2C5.MOTR._CRS.SBUF */
                }
        ...
        Device (I2C6)
        {
            ...
            {
                Name (_ADR, Zero)  // _ADR: Address
                Name (_HID, "FTSC0001")  // _HID: Hardware ID
                Name (_CID, "PNP0C50" /* HID Protocol Device (I2C bus) */)  // _CID: Compatible ID
                Name (_S0W, Zero)  // _S0W: S0 Device Wake State
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (ABUF) /* \_SB_.PCI0.I2C6.TCSC._CRS.ABUF */
                }
            ...
            Device (TCSE)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    Name (ABUF, ResourceTemplate ()
                    {
                        I2cSerialBusV2 (0x004B, ControllerInitiated, 0x0019F0A0,
                            AddressingMode7Bit, "\\_SB.PCI0.I2C6",
                            0x00, ResourceConsumer, , Exclusive,
                            )
                        GpioInt (Level, ActiveLow, Shared, PullDefault, 0x0000,
                    ...
                    CreateDWordField (ABUF, \_SB.PCI0.I2C6.TCSE._CRS._Y18._BAS, B0BA)  // _BAS: Base Address
                    CreateDWordField (ABUF, \_SB.PCI0.I2C6.TCSE._CRS._Y18._LEN, B0LN)  // _LEN: Length
                    B0BA = P20A /* \P20A */
                    B0LN = P20L /* \P20L */
                    Return (ABUF) /* \_SB_.PCI0.I2C6.TCSE._CRS.ABUF */
                }
            ...
            Device (TCSD)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    CreateDWordField (WBUF, \_SB.PCI0.I2C6.TCSD._CRS._Y19._BAS, B0BA)  // _BAS: Base Address
                    CreateDWordField (WBUF, \_SB.PCI0.I2C6.TCSD._CRS._Y19._LEN, B0LN)  // _LEN: Length
                    B0BA = P20A /* \P20A */
                    B0LN = P20L /* \P20L */
                    Return (WBUF) /* \_SB_.PCI0.I2C6.TCSD._CRS.WBUF */
                }
        ...
        Device (I2C7)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (RBUF, \_SB.PCI0.I2C7._Y1A._BAS, B0BA)  // _BAS: Base Address
                CreateDWordField (RBUF, \_SB.PCI0.I2C7._Y1A._LEN, B0LN)  // _LEN: Length
                B0BA = I70A /* \I70A */
                B0LN = I70L /* \I70L */
        ...
        Device (RP01)
        {
            ...
            PowerResource (WRST, 0x05, 0x0000)
            {
                ...
                Method (_RST, 0, NotSerialized)  // _RST: Device Reset
                {
                    ...
                    If ((BTHM == 0x02))
                    {
                        If ((DCAP & 0x10000000))
                        {
                            Local0 = DCTR /* \_SB_.PCI0.RP01.DCTR */
                            Local0 |= 0x8000
                            DCTR = Local0
                        }
                    }
            ...
            Device (BRC1)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (RBUF) /* \_SB_.PCI0.RP01.BRC1._CRS.RBUF */
                }
        ...
        Device (IISH)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (RBUF, \_SB.PCI0.IISH._Y1B._BAS, B0BA)  // _BAS: Base Address
                B0BA = ISH0 /* \ISH0 */
                CreateDWordField (RBUF, \_SB.PCI0.IISH._Y1C._BAS, B1BA)  // _BAS: Base Address
                B1BA = ISH1 /* \ISH1 */
        ...
        Device (LPEA)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                If (((BDID != 0x09) && (BDID != 0x0A)))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.LPEA._Y1D._BAS, B0BA)  // _BAS: Base Address
                    B0BA = LPE0 /* \LPE0 */
                    CreateDWordField (RBUF, \_SB.PCI0.LPEA._Y1E._BAS, B1BA)  // _BAS: Base Address
                    B1BA = LPE1 /* \LPE1 */
                    CreateDWordField (RBUF, \_SB.PCI0.LPEA._Y1F._BAS, B2BA)  // _BAS: Base Address
                    B2BA = LPE2 /* \LPE2 */
                    Return (RBUF) /* \_SB_.PCI0.LPEA.RBUF */
                }

                CreateDWordField (WBUF, \_SB.PCI0.LPEA._Y20._BAS, B3BA)  // _BAS: Base Address
                B3BA = LPE0 /* \LPE0 */
                CreateDWordField (WBUF, \_SB.PCI0.LPEA._Y21._BAS, B4BA)  // _BAS: Base Address
                B4BA = LPE1 /* \LPE1 */
                CreateDWordField (WBUF, \_SB.PCI0.LPEA._Y22._BAS, B5BA)  // _BAS: Base Address
                B5BA = LPE2 /* \LPE2 */
            ...
            Device (ADMA)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    CreateDWordField (RBUF, \_SB.PCI0.LPEA.ADMA._Y23._BAS, B3BA)  // _BAS: Base Address
                    B3BA = LPE0 /* \LPE0 */
        ...
        Device (SPRC)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y24._BAS, BR01)  // _BAS: Base Address
                BR01 = EM1A /* \EM1A */
                If (((BR01 != Zero) && (BR01 != 0xFFFFF000)))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y24._LEN, LN01)  // _LEN: Length
                    LN01 = EM1L /* \EM1L */
                }

                CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y25._BAS, BR02)  // _BAS: Base Address
                BR02 = SI1A /* \SI1A */
                If (((BR02 != Zero) && (BR02 != 0xFFFFF000)))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y25._LEN, LN02)  // _LEN: Length
                    LN02 = SI1L /* \SI1L */
                }

                CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y26._BAS, BR03)  // _BAS: Base Address
                BR03 = SD1A /* \SD1A */
                If (((BR03 != Zero) && (BR03 != 0xFFFFF000)))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y26._LEN, LN03)  // _LEN: Length
                    LN03 = SD1L /* \SD1L */
                }

                CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y27._BAS, BR04)  // _BAS: Base Address
                BR04 = D11A /* \D11A */
                If (((BR04 != Zero) && (BR04 != 0xFFFFF000)))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y27._LEN, LN04)  // _LEN: Length
                    LN04 = D11L /* \D11L */
                }

                CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y28._BAS, BR05)  // _BAS: Base Address
                BR05 = P11A /* \P11A */
                If (((BR05 != Zero) && (BR05 != 0xFFFFF000)))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y28._LEN, LN05)  // _LEN: Length
                    LN05 = P11L /* \P11L */
                }

                CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y29._BAS, BR06)  // _BAS: Base Address
                BR06 = P21A /* \P21A */
                If (((BR06 != Zero) && (BR06 != 0xFFFFF000)))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y29._LEN, LN06)  // _LEN: Length
                    LN06 = P21L /* \P21L */
                }

                CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y2A._BAS, BR07)  // _BAS: Base Address
                BR07 = U11A /* \U11A */
                If (((BR07 != Zero) && (BR07 != 0xFFFFF000)))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y2A._LEN, LN07)  // _LEN: Length
                    LN07 = U11L /* \U11L */
                }

                CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y2B._BAS, BR08)  // _BAS: Base Address
                BR08 = U21A /* \U21A */
                If (((BR08 != Zero) && (BR08 != 0xFFFFF000)))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y2B._LEN, LN08)  // _LEN: Length
                    LN08 = U21L /* \U21L */
                }

                CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y2C._BAS, BR09)  // _BAS: Base Address
                BR09 = SP1A /* \SP1A */
                If (((BR09 != Zero) && (BR09 != 0xFFFFF000)))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y2C._LEN, LN09)  // _LEN: Length
                    LN09 = SP1L /* \SP1L */
                }

                CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y2D._BAS, BR10)  // _BAS: Base Address
                BR10 = S21A /* \S21A */
                If (((BR10 != Zero) && (BR10 != 0xFFFFF000)))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y2D._LEN, LN10)  // _LEN: Length
                    LN10 = S21L /* \S21L */
                }

                CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y2E._BAS, BR11)  // _BAS: Base Address
                BR11 = S31A /* \S31A */
                If (((BR11 != Zero) && (BR11 != 0xFFFFF000)))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y2E._LEN, LN11)  // _LEN: Length
                    LN11 = S31L /* \S31L */
                }

                CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y2F._BAS, BR12)  // _BAS: Base Address
                BR12 = D21A /* \D21A */
                If (((BR12 != Zero) && (BR12 != 0xFFFFF000)))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y2F._LEN, LN12)  // _LEN: Length
                    LN12 = D21L /* \D21L */
                }

                CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y30._BAS, BR13)  // _BAS: Base Address
                BR13 = I11A /* \I11A */
                If (((BR13 != Zero) && (BR13 != 0xFFFFF000)))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y30._LEN, LN13)  // _LEN: Length
                    LN13 = I11L /* \I11L */
                }

                CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y31._BAS, BR14)  // _BAS: Base Address
                BR14 = I21A /* \I21A */
                If (((BR14 != Zero) && (BR14 != 0xFFFFF000)))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y31._LEN, LN14)  // _LEN: Length
                    LN14 = I21L /* \I21L */
                }

                CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y32._BAS, BR15)  // _BAS: Base Address
                BR15 = I31A /* \I31A */
                If (((BR15 != Zero) && (BR15 != 0xFFFFF000)))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y32._LEN, LN15)  // _LEN: Length
                    LN15 = I31L /* \I31L */
                }

                CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y33._BAS, BR16)  // _BAS: Base Address
                BR16 = I41A /* \I41A */
                If (((BR16 != Zero) && (BR16 != 0xFFFFF000)))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y33._LEN, LN16)  // _LEN: Length
                    LN16 = I41L /* \I41L */
                }

                CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y34._BAS, BR17)  // _BAS: Base Address
                BR17 = I51A /* \I51A */
                If (((BR17 != Zero) && (BR17 != 0xFFFFF000)))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y34._LEN, LN17)  // _LEN: Length
                    LN17 = I51L /* \I51L */
                }

                CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y35._BAS, BR18)  // _BAS: Base Address
                BR18 = I61A /* \I61A */
                If (((BR18 != Zero) && (BR18 != 0xFFFFF000)))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y35._LEN, LN18)  // _LEN: Length
                    LN18 = I61L /* \I61L */
                }

                CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y36._BAS, BR19)  // _BAS: Base Address
                BR19 = I71A /* \I71A */
                If (((BR19 != Zero) && (BR19 != 0xFFFFF000)))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.SPRC._Y36._LEN, LN19)  // _LEN: Length
                    LN19 = I71L /* \I71L */
                }
        ...
        Device (SEC0)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                If ((((OSYS == 0x07DF) || (OSID == 0x04)) && (PAVL != 
                    Zero)))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.SEC0._Y37._BAS, B0BA)  // _BAS: Base Address
                    CreateDWordField (RBUF, \_SB.PCI0.SEC0._Y37._LEN, B0LN)  // _LEN: Length
                    B0BA = PAVB /* \PAVB */
                    B0LN = PAVL /* \PAVL */
            ...
            Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
            {
                If ((Arg0 == ToUUID ("ad27b3f7-13af-4fa3-93c9-eefd1f9d6ac7") /* Unknown UUID */))
                {
                    Switch (Arg2)
                    {
                        Case (Zero)
    ...
    Scope (_SB.PCI0)
    {
        ...
        Device (GFX0)
        {
            ...
            Device (ISP0)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    CreateDWordField (SBUF, \_SB.PCI0.GFX0.ISP0._Y38._BAS, B0BA)  // _BAS: Base Address
                    B0BA = ISPA /* \ISPA */
    ...
    OperationRegion (WLGP, SystemMemory, 0xFED9D800, One)
    Field (WLGP, ByteAcc, NoLock, Preserve)
    {
            ,   1, 
        WLRQ,   1
    }
    ...
    Scope (_SB)
    {
        ...
        Device (GPO1)
        {
            ...
            Method (_E03, 0, Serialized)  // _Exx: Edge-Triggered GPE, xx=0x00-0xFF
            {
        ...
        Device (GPO2)
        {
            ...
            Method (_AEI, 0, NotSerialized)  // _AEI: ACPI Event Interrupts
            {
                ...
                If ((OSID == One))
                {
                    Return (LBUF) /* \_SB_.GPO2._AEI.LBUF */
                }
            }
            ...
            {
                LIDA ^= One
                LIDS = HALL /* \_SB_.GPO2.HALL */
                ^^PCI0.GFX0.GLID (LIDS)
                Notify (LID0, 0x80) // Status Change
            }

            OperationRegion (HALS, SystemMemory, 0xFED94818, One)
            Field (HALS, ByteAcc, NoLock, Preserve)
            {
                HALL,   1
            }
                ...
                Method (_E12, 0, NotSerialized)  // _Exx: Edge-Triggered GPE, xx=0x00-0xFF
                {
                    ...
                    If ((BDID == 0x08))
                    {
                        ...
                        If (CondRefOf (\_SB.PCI0.I2C7.BATC, Local1))
                        {
                            ...
                            If ((Local7 == Zero))
                            {
                                Notify (^^^I2C2.CWMD, 0x02) // Device Wake
                                ^^^I2C2.CWMD.CGMD = Local7
                            }
                        }
                    }
                }
        ...
        PowerResource (P4DW, 0x05, 0x0000)
        {
            Name (_DEP, Package (0x02)  // _DEP: Dependencies
            {
                ^PCI0.I2C7, 
            ...
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                If ((^^PCI0.I2C7.PMI5.AVBG == One))
                {
                    ^^PCI0.I2C7.PMI5.GP4D = Zero
                    If ((^^PCI0.I2C7.PMI5.AVBL == One))
                    {
                        Return (^^PCI0.I2C7.PMI5.VP4D) /* \_SB_.PCI0.I2C7.PMI5.VP4D */
                    }
                }
    ...
    Scope (_SB.PCI0.I2C3)
    {
        ...
        OperationRegion (MRGB, GenericSerialBus, Zero, 0x0100)
        Field (MRGB, BufferAcc, NoLock, Preserve)
        {
            Connection (MRIC), 
            AccessAs (BufferAcc, AttribByte), 
            MR00,   8
    ...
    Scope (_SB.PCI0.I2C1)
    {
        ...
        Device (ANF1)
        {
            Name (_HID, "TXN27520")  // _HID: Hardware ID
            Name (_CID, "TXN27520")  // _CID: Compatible ID
        ...
        OperationRegion (MIFG, GenericSerialBus, Zero, 0x0100)
        Field (MIFG, BufferAcc, NoLock, Preserve)
        {
            Connection (MFIC), 
            Offset (0x12), 
    ...
    Scope (_SB.PCI0.I2C7)
    {
        ...
        Device (WIDR)
        {
            ...
            Method (PSOC, 0, NotSerialized)
            {
                ...
                If ((AVBL == One))
                {
                    Local1 = SOC /* \_SB_.PCI0.I2C7.WIDR.SOC_ */
                    Return (Local1)
                }
        ...
        Device (BATC)
        {
            ...
            {
                ^^PMI5.SET (One, 0x5E, 0x25, 0x6A)
                ^^PMI5.SET (One, 0x5E, 0x26, Arg0)
                ^^PMI5.SET (One, 0x5E, 0x24, 0x02)
                Local0 = ^^PMI5.GET (One, 0x5E, 0x28)
                Return (Local0)
            }
            ...
            Method (_BIX, 0, NotSerialized)  // _BIX: Battery Information Extended
            {
                If ((^^^I2C1.AVBL == One))
                {
                    BUF2 = ^^^I2C1.MF12 /* \_SB_.PCI0.I2C1.MF12 */
                    If ((BSTS != One))
                    {
                ...
                Divide (DSCP, 0x0A, Local0, Local1)
                BIXP [0x06] = Local1
                Divide (DSCP, 0x19, Local0, Local1)
                BIXP [0x07] = Local1
            ...
            Method (_BST, 0, NotSerialized)  // _BST: Battery Status
            {
                ...
                If ((^^PMI5.AVBL == One))
                {
                    ...
                    If ((RGND == Zero))
                    {
                        ...
                        ^^PMI5.SET (One, 0x5E, 0x24, 0x02)
                        Local4 = ^^PMI5.GET (One, 0x5E, 0x28)
                        Local4 &= 0xCF
                        ^^PMI5.SET (One, 0x5E, 0x25, 0x6A)
                        ^^PMI5.SET (One, 0x5E, 0x26, 0x07)
                        ^^PMI5.SET (One, 0x5E, 0x27, Local4)
                        ^^PMI5.SET (One, 0x5E, 0x24, One)
                    ...
                    Local0 = CCLI ()
                    BUF2 = ^^^I2C1.MF20 /* \_SB_.PCI0.I2C1.MF20 */
                    If ((BSTS != One))
                    {
                        Local2 = WRD1 /* \_SB_.PCI0.I2C7.BATC.WRD1 */
                    }
                    ...
                    BSTP [Zero] = Local1
                    BUF2 = ^^^I2C1.MF14 /* \_SB_.PCI0.I2C1.MF14 */
                    If ((BSTS != One))
                    {
                        Local1 = WRD1 /* \_SB_.PCI0.I2C7.BATC.WRD1 */
                    }
                    ...
                    BUF2 = ^^^I2C1.MF10 /* \_SB_.PCI0.I2C1.MF10 */
                    If ((BSTS != One))
                    {
                        Local1 = WRD1 /* \_SB_.PCI0.I2C7.BATC.WRD1 */
                        BSTP [0x02] = Local1
                    ...
                    BUF2 = ^^^I2C1.MF08 /* \_SB_.PCI0.I2C1.MF08 */
                    If ((BSTS != One))
                    {
                        Local1 = WRD1 /* \_SB_.PCI0.I2C7.BATC.WRD1 */
                        BSTP [0x03] = Local1
            ...
            Method (RGRB, 0, NotSerialized)
            {
                DATA = Zero
                ^^^I2C3.MR04 = BUFF /* \_SB_.PCI0.I2C7.BATC.BUFF */
                DATA = 0x20
                ^^^I2C3.MR00 = BUFF /* \_SB_.PCI0.I2C7.BATC.BUFF */
                DATA = 0xBB
                ^^^I2C3.MR08 = BUFF /* \_SB_.PCI0.I2C7.BATC.BUFF */
                DATA = 0xAA
                ^^^I2C3.MR05 = BUFF /* \_SB_.PCI0.I2C7.BATC.BUFF */
                DATA = 0x12
                ^^^I2C3.MR01 = BUFF /* \_SB_.PCI0.I2C7.BATC.BUFF */
                DATA = Zero
                ^^^I2C3.MR02 = BUFF /* \_SB_.PCI0.I2C7.BATC.BUFF */
                DATA = 0x20
                ^^^I2C3.MR04 = BUFF /* \_SB_.PCI0.I2C7.BATC.BUFF */
                DATA = 0x56
                ^^^I2C3.MR02 = BUFF /* \_SB_.PCI0.I2C7.BATC.BUFF */
            ...
            Method (RGGO, 0, NotSerialized)
            {
                DATA = Zero
                ^^^I2C3.MR04 = BUFF /* \_SB_.PCI0.I2C7.BATC.BUFF */
                DATA = 0x44
                ^^^I2C3.MR07 = BUFF /* \_SB_.PCI0.I2C7.BATC.BUFF */
                DATA = Zero
                ^^^I2C3.MR00 = BUFF /* \_SB_.PCI0.I2C7.BATC.BUFF */
                DATA = 0x04
                ^^^I2C3.MR04 = BUFF /* \_SB_.PCI0.I2C7.BATC.BUFF */
            ...
            Method (RGBO, 0, NotSerialized)
            {
                DATA = Zero
                ^^^I2C3.MR04 = BUFF /* \_SB_.PCI0.I2C7.BATC.BUFF */
                DATA = 0x44
                ^^^I2C3.MR06 = BUFF /* \_SB_.PCI0.I2C7.BATC.BUFF */
                DATA = Zero
                ^^^I2C3.MR00 = BUFF /* \_SB_.PCI0.I2C7.BATC.BUFF */
                DATA = One
                ^^^I2C3.MR04 = BUFF /* \_SB_.PCI0.I2C7.BATC.BUFF */
            ...
            Method (CCLI, 0, NotSerialized)
            {
                ...
                BUF2 = ^^^I2C1.MF28 /* \_SB_.PCI0.I2C1.MF28 */
                If ((BSTS != One))
                {
                    Local2 = WRD1 /* \_SB_.PCI0.I2C7.BATC.WRD1 */
                    Local2 -= 0x0AAB
                ...
                Local1 = S2TM /* \_SB_.PCI0.I2C7.BATC.S2TM */
                Local1 -= 0x0AAB
                Divide (Local1, 0x0A, Local5, Local1)
                If ((Local1 < 0x2D))
                {
                    Local3 = 0x2F
                }

                If (((Local1 >= 0x2D) && (Local1 < 0x2F)))
                {
                    Local3 = 0x1C
                }
            ...
            {
                ADBG ("INTF")
                BUF2 = ^^^I2C1.MF00 /* \_SB_.PCI0.I2C1.MF00 */
                If ((BSTS != One))
                {
                    Local1 = WRD1 /* \_SB_.PCI0.I2C7.BATC.WRD1 */
                    ADBG ("FG00")
            ...
            Method (_BTM, 1, NotSerialized)  // _BTM: Battery Time
            {
                ...
                If ((^^^I2C1.AVBL == One))
                {
                    ...
                    If ((BSTS != One))
                    {
                        Local3 = WRD1 /* \_SB_.PCI0.I2C7.BATC.WRD1 */
                    }

                    Local1 -= Local2
                    Divide (Local1, Local3, Local4, Local0)
                    Local0 *= 0x0E10
                    Return (Local0)
                }
            ...
            Method (PSOC, 0, NotSerialized)
            {
                If ((^^^I2C1.AVBL == One))
                {
                    ...
                    If ((BSTS != One))
                    {
                        Local0 = WRD1 /* \_SB_.PCI0.I2C7.BATC.WRD1 */
                    }
            ...
            Method (PSRC, 0, Serialized)
            {
                ...
                If ((^^PMI5.AVBL == One))
                {
                    ...
                    Else
                    {
                        ...
                        Local0 = ^^PMI5.GET (One, 0x5E, 0x28)
                        ^^PMI5.SET (One, 0x5E, 0x25, 0x6A)
                        ^^PMI5.SET (One, 0x5E, 0x26, 0x0D)
                        ^^PMI5.SET (One, 0x5E, 0x24, 0x02)
                        Local3 = ^^PMI5.GET (One, 0x5E, 0x28)
                        Local3 &= 0x7F
                        ^^PMI5.SET (One, 0x5E, 0x25, 0x6A)
                        ^^PMI5.SET (One, 0x5E, 0x26, 0x0D)
                        ^^PMI5.SET (One, 0x5E, 0x27, Local3)
                        ^^PMI5.SET (One, 0x5E, 0x24, One)
                        ^^PMI5.SET (One, 0x5E, 0x25, 0x6A)
                        ^^PMI5.SET (One, 0x5E, 0x26, 0x0D)
                        ^^PMI5.SET (One, 0x5E, 0x24, 0x02)
                        ...
                        If ((BSTS != One))
                        {
                            Local4 = WRD1 /* \_SB_.PCI0.I2C7.BATC.WRD1 */
                        }
